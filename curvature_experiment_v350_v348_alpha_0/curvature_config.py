...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v350_v348_alpha_0"  # ← v350 SWEEP (2026-09-03). 在 v348 (midpoint-only baseline, α=0.5) 基础上 sweep L0 geodesic midpoint α=0.0 (pure codeword passthrough). R36n (e) 几何变换参数化扩展: log_mid = α·log_r + (1-α)·log_e. 验证 α=0.0 是否优于 α=0.5 baseline.

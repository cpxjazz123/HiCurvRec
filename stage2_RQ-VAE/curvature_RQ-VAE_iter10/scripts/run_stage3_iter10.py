"""Run Stage3 with iter10 SIDs through its hard-coded four-GPU launcher."""
...
spec = importlib.util.spec_from_file_location(
    "genrec_stage3_iter10", f"{STAGE3_DIR}/train_HG-Rec.py"
)
...
trainer.RQVAE_VARIANT = "iter10_sinkhorn_iters_5"
trainer.LOG_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter10/logs/"
)
trainer.SAVE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter10/ckpt/"
)

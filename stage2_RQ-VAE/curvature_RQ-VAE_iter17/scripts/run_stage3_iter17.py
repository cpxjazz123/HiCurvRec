"""Run Stage3 with iter17 SIDs through its hard-coded four-GPU launcher."""
...
spec = importlib.util.spec_from_file_location(
    "genrec_stage3_iter17", f"{STAGE3_DIR}/train_HG-Rec.py"
)
trainer = importlib.util.module_from_spec(spec)
spec.loader.exec_module(trainer)
trainer.CODE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/"
    "curvature_RQ-VAE_iter17/item_sids.json"
)
trainer.RQVAE_VARIANT = "iter17_riemannian_adam_1_over_c"
trainer.LOG_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter17/logs/"
)
trainer.SAVE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter17/ckpt/"
)

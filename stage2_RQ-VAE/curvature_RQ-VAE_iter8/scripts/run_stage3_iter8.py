"""Run Stage3 with iter8 SIDs through its hard-coded four-GPU launcher."""
...
spec = importlib.util.spec_from_file_location(
    "genrec_stage3_iter8", f"{STAGE3_DIR}/train_HG-Rec.py"
)
...
trainer.RQVAE_VARIANT = "iter8_curvature_dependent_sinkhorn"
trainer.LOG_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter8/logs/"
)
trainer.SAVE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter8/ckpt/"
)

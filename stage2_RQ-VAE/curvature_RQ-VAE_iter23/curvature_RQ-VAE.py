...
# Standard AdamW and iter19 reciprocal Sinkhorn epsilon remain unchanged; iter23 moves the symmetric behavior objective from pre-quantization residuals to hard quantized embeddings.
ADAMW_BASE_LR = 1e-3
ADAMW_BETA1 = 0.9

...
# === Path anchor: isolated iter7 result subtree ===
_CONFIG_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter7/results"

# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "iter7_wide_curriculum_warmstart"
...
#   stage2 -> stage2_RQ-VAE/curvature_RQ-VAE_iter7/{results,dataset}
...
# iter7 outputs stay isolated from baseline and earlier variants.
RQVAE_OUT_DIR   = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter7/results/out/rqvae/instruments"
RQVAE_CKPT_PATH = os.path.join(RQVAE_OUT_DIR, "rqvae_best.pth")
RAW_SIDS_NPY    = os.path.join(RQVAE_OUT_DIR, "sids_raw.npy")
SIDS_NPY        = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter7/dataset/Instruments/sids_for_hgrec.npy"
ITEM_SIDS_JSON  = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter7/results/item_sids.json"

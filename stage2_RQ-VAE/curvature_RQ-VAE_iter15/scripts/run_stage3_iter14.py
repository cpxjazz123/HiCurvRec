"""Run Stage3 with iter14 SIDs through its hard-coded four-GPU launcher."""
...
spec = importlib.util.spec_from_file_location(
    "genrec_stage3_iter14", f"{STAGE3_DIR}/train_HG-Rec.py"
)
...
trainer.CODE_PATH = (
    ...
    "curvature_RQ-VAE_iter14/item_sids.json"
)
trainer.RQVAE_VARIANT = "iter14_soft_behavior_branching_curvature"
trainer.LOG_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter14/logs/"
)
trainer.SAVE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter14/ckpt/"
)

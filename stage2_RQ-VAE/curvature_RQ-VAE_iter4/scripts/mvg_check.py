...
def _load_training_module():
    spec = importlib.util.spec_from_file_location("rqtrain_iter4", TRAIN_SCRIPT)
...
def main() -> None:
    ...
    with tempfile.NamedTemporaryFile(
        prefix="rqvae_iter4_mvg_", suffix=".pt", dir=SCRIPT_DIR, delete=False
    ) as handle:
    ...
    print("MVG PASS")
    print("temporary_checkpoint_roundtrip=PASS")

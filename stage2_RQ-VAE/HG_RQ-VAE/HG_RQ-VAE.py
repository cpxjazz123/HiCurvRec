...
CONFIG = {
    # 数据集路径 (相对 cwd, 与原版兼容)
    "data_path": "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/HG_RQ-VAE/dataset/Amazon_2023_Instruments/item_emb.parquet",
    "ckpt_dir": "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/HG_RQ-VAE/ckpt",
    ...
    "kmeans_init": True,
    "kmeans_iters": 1000,
    "sk_epsilons": [0.05, 0.05, 0.003],  # L1+L2 加 Sinkhorn 防 collapse (orig: [0.0, 0.0, 0.003])
    "sk_iters": 50,

...
ITER_SID = (
    ...
    f"curvature_RQ-VAE_{ITER_ID}/dataset/Instruments/sids_for_hgrec.npy"
)

TIGER_SID = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter18/dataset/Instruments/sids_for_hgrec.npy"
ITEM_EMB  = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter25/dataset/Instruments/item_emb.npy"
INTER_JS  = "/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec_amazon2023/dataset/Amazon_2023_Instruments/Instruments.inter.json"  # HitRate@50 gate removed (CLAUDE.md §2); we skip _hitrate below.
...
def main():
    ...
    # HitRate@50 was removed as a gate by CLAUDE.md §2; skip _hitrate here.
    hr = {50: float("nan")}
    ...
    print(f"  HitRate@50                 : n/a (CLAUDE.md §2, gate removed)")

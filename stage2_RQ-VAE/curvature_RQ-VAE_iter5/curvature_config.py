...
# === 路径推导锚点: 本文件所在目录 ===
_CONFIG_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter5"

# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "iter5_mixed_curvature_HHS"  # iter5: Mixed-curvature product manifold H^{c1} x H^{c2} x S (spherical). 跨层不同几何, L0=hyp c=0.5, L1=hyp c=1.0, L2=sphere. 论文: Gu et al. 2019 "Learning Mixed-Curvature Representations". R36n 未尝试方向.
...
RQVAE_OUT_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter5/out/rqvae/instruments"  # iter5 独立 ckpt 目录

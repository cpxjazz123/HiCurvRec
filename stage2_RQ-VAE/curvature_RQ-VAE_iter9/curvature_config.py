...
# === Path anchor: isolated iter9 result subtree ===
_CONFIG_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter9/results"

# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "iter9_power_law_sinkhorn"
...
#   stage2 -> stage2_RQ-VAE/curvature_RQ-VAE_iter9/{results,dataset}
...
# iter9 outputs stay isolated from baseline and earlier variants.
RQVAE_OUT_DIR   = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter9/results/out/rqvae/instruments"
RQVAE_CKPT_PATH = os.path.join(RQVAE_OUT_DIR, "rqvae_best.pth")
RAW_SIDS_NPY    = os.path.join(RQVAE_OUT_DIR, "sids_raw.npy")
SIDS_NPY        = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter9/dataset/Instruments/sids_for_hgrec.npy"
ITEM_SIDS_JSON  = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter9/results/item_sids.json"

"""Run Stage3 with iter9 SIDs through its hard-coded four-GPU launcher."""
...
spec = importlib.util.spec_from_file_location(
    "genrec_stage3_iter9", f"{STAGE3_DIR}/train_HG-Rec.py"
)
...
trainer.CODE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter9/"
    "results/item_sids.json"
)
trainer.RQVAE_VARIANT = "iter9_power_law_sinkhorn"
trainer.LOG_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter9/logs/"
)
trainer.SAVE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter9/ckpt/"
)

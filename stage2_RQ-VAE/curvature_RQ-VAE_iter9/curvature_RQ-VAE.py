...
# iter9 P2: SID Dropout Augmentation (training-only, 不修改 SID 几何 / 损失 / 曲率)
USE_SID_DROPOUT_AUG = True
SID_MASK_RATE_L1 = 0.15
SID_MASK_RATE_L2 = 0.15
...
def main():
    ...
    # iter9 P2: 把 SID dropout aug flag 挂到模型上 (training-only)
    model._use_sid_dropout_aug = USE_SID_DROPOUT_AUG
    model._sid_mask_rate_l1 = SID_MASK_RATE_L1
    model._sid_mask_rate_l2 = SID_MASK_RATE_L2

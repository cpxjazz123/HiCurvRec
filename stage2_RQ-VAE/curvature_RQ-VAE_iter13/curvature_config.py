...
# === Path anchor: isolated iter13 result subtree ===
_CONFIG_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter13/results"

# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "iter13_per_layer_temperature"
...
#   stage2 -> stage2_RQ-VAE/curvature_RQ-VAE_iter13/{results,dataset}
...
# iter13 outputs stay isolated from baseline and earlier variants.
RQVAE_OUT_DIR   = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter13/results/out/rqvae/instruments"
RQVAE_CKPT_PATH = os.path.join(RQVAE_OUT_DIR, "rqvae_best.pth")
RAW_SIDS_NPY    = os.path.join(RQVAE_OUT_DIR, "sids_raw.npy")
SIDS_NPY        = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter13/dataset/Instruments/sids_for_hgrec.npy"
ITEM_SIDS_JSON  = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter13/results/item_sids.json"

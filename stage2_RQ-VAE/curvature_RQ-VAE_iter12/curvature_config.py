...
# === Path anchor: isolated iter12 result subtree ===
_CONFIG_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter12"

# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "iter12_behavior_branching_per_layer_curvature"
...
#   stage2 -> stage2_RQ-VAE/curvature_RQ-VAE_iter12/{results,dataset}
...
# iter12 outputs go to the unified results dir (Project Rules §0 / §10).
RQVAE_OUT_DIR   = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter12/out/rqvae/instruments"
RQVAE_CKPT_PATH = os.path.join(RQVAE_OUT_DIR, "rqvae_best.pth")
RAW_SIDS_NPY    = os.path.join(RQVAE_OUT_DIR, "sids_raw.npy")
SIDS_NPY        = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter12/dataset/Instruments/sids_for_hgrec.npy"
ITEM_SIDS_JSON  = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter12/item_sids.json"
PARQUET_DIR     = STAGE0_DIR  # HG-Rec train/valid/test.parquet 现在就在 STAGE0_DIR

# iter12: per-layer behavior-branching factor. Computed once by
# scripts/compute_behavior_branching.py before training starts; baked into
# `c_branch_mid_l` below as a non-trainable scaling that warps the cyclic schedule
# so layers with more behavior branches (more fine-grained user-history discrimination
# required) carry a larger geometric capacity than layers with shallow branching.
BEHAVIOR_BRANCH_FILE = "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter12/scripts/computed_behavior_branching.json"

...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/LETTER_RQ-VAE/sentence_t5.npy", help="Input data path.")
    ...
    parser.add_argument('--n_clusters', type=int, default=10, help='diversity-loss clusters')
    parser.add_argument('--sample_strategy', type=str, default="all", help='sample_strategy')
    parser.add_argument('--cf_emb', type=str, default="/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/LETTER_RQ-VAE/cf_emb.pt", help='cf emb')
   
    parser.add_argument('--layers', type=int, nargs='+', default=[2048,1024,512,256,128,64], help='hidden sizes of every layer')

    parser.add_argument("--ckpt_dir", type=str, default="/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/LETTER_RQ-VAE/ckpt", help="output directory for model")
...
if __name__ == '__main__':
    ...
    # Use the A100 tensor-core path for the large MLP layers.

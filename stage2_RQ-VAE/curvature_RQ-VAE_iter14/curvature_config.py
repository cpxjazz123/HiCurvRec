...
# === Path anchor: isolated iter14 result subtree ===
_CONFIG_DIR = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter14"

# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "iter14_soft_behavior_branching_curvature"
...
ITEM_JSON_PATH  = os.path.join(DATASET_ROOT, "Amazon_2023_Instruments/Instruments.item.json")
...
RQVAE_OUT_DIR   = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter14/out/rqvae/instruments"
RQVAE_CKPT_PATH = os.path.join(RQVAE_OUT_DIR, "rqvae_best.pth")
RAW_SIDS_NPY    = os.path.join(RQVAE_OUT_DIR, "sids_raw.npy")
SIDS_NPY        = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter14/dataset/Instruments/sids_for_hgrec.npy"
ITEM_SIDS_JSON  = "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/curvature_RQ-VAE_iter14/item_sids.json"
PARQUET_DIR     = STAGE0_DIR

# iter14: soft behavior-calibrated per-layer curvature multiplier (fixed alpha=0.1).
# Computed once by scripts/compute_behavior_branching.py before training.
BEHAVIOR_BRANCH_FILE = (
    "/home/wlia0047/ar57/wenyu/GeneRec/stage2_RQ-VAE/curvature_RQ-VAE_iter14/"

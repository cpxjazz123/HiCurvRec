...
# Standard AdamW and iter19 reciprocal Sinkhorn epsilon remain unchanged; iter22 adds the reverse direction to iter21's multi-positive behavior objective.
ADAMW_BASE_LR = 1e-3
ADAMW_BETA1 = 0.9

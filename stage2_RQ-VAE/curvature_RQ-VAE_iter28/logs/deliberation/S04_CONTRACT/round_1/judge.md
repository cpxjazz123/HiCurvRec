...
CANONICAL_DECISION=Both drafts agree on the canonical artifact.  Canonical artifact is logs/mechanism_contract_iter28.json.
CANONICAL_ARTIFACT=mechanism_contract_iter28.json
CONFIDENCE=HIGH

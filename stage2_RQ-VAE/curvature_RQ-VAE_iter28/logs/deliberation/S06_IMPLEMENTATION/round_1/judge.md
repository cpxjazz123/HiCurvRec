...
CANONICAL_DECISION=Both drafts agree on the canonical artifact.  Canonical artifact is logs/implementation_plan_iter28.md.
CANONICAL_ARTIFACT=implementation_plan_iter28.md
CONFIDENCE=HIGH

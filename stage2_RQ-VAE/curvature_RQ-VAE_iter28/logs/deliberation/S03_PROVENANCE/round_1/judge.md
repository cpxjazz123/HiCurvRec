...
CANONICAL_DECISION=Both drafts agree on the canonical artifact.  Canonical artifact is logs/mechanism_manifest_iter28.md.
CANONICAL_ARTIFACT=mechanism_manifest_iter28.md
CONFIDENCE=HIGH

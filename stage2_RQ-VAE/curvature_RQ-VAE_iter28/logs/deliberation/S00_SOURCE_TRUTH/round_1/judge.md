...
CANONICAL_DECISION=Both drafts agree on the canonical artifact.  Canonical artifact is logs/source_snapshot_iter28.md.
CANONICAL_ARTIFACT=source_snapshot_iter28.md
CONFIDENCE=HIGH

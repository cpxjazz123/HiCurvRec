...
CANONICAL_DECISION=Both drafts agree on the canonical artifact.  Canonical artifact is logs/protocol_manifest_iter28.md.
CANONICAL_ARTIFACT=protocol_manifest_iter28.md
CONFIDENCE=HIGH

...
CANONICAL_DECISION=Both drafts agree on the canonical artifact.  Canonical artifact is logs/one_factor_diff_iter28.md.
CANONICAL_ARTIFACT=one_factor_diff_iter28.md
CONFIDENCE=HIGH

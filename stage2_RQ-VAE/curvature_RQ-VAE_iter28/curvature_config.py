"""iter28 CAO-1 Sinkhorn-weighted Riemannian EMA codebook (SREMA) — hard-coded paths.

修改 MECHANISM_NAME 即可切换实验 (cp -r baseline 后编辑此文件即可).
所有路径相对于本文件所在目录 (curvature_RQ-VAE_iter28/), 不依赖 cwd.
...
# === 机制标识 ===
MECHANISM_NAME = "iter28_sinkhorn_riemannian_ema_codebook"

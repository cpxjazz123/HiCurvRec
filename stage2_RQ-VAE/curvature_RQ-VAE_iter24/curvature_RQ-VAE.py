...
# Standard AdamW and iter19 reciprocal Sinkhorn epsilon remain unchanged; iter24 applies inverse-sqrt in-batch target-frequency weights to the symmetric residual behavior objective.
ADAMW_BASE_LR = 1e-3
ADAMW_BETA1 = 0.9

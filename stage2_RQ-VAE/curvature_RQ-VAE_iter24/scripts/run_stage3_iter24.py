"""Run Stage3 with iter24 SIDs through its hard-coded four-GPU launcher."""
...
spec = importlib.util.spec_from_file_location(
    "genrec_stage3_iter24", f"{STAGE3_DIR}/train_HG-Rec.py"
)
trainer = importlib.util.module_from_spec(spec)
spec.loader.exec_module(trainer)
trainer.CODE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage2_RQ-VAE/"
    "curvature_RQ-VAE_iter24/item_sids.json"
)
trainer.RQVAE_VARIANT = "iter24_balanced_behavior"
trainer.LOG_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter24/logs/"
)
trainer.SAVE_PATH = (
    "/home/wlia0047/ar57/wenyu/GeneRec/results/stage3_T5Train/"
    "curvature_RQ-VAE_iter24/ckpt/"
)

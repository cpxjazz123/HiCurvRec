...
# === 机制标识 (R52 + R53 联动) ===
# v102: 3-mode ablation 切换此值即可 (standard / euclidean / curvature). SAVE_DIR_ROOT 自动加 _mode 后缀避免覆盖.
V102_INJECTION_MODE = "curvature"  # ← 切换 ablation: "standard" | "euclidean" | "curvature"
MECHANISM_NAME = "curvature_aware_sid_v102"
SAVE_DIR_ROOT = os.path.join(
    _CONFIG_DIR,
    "out/decoder/instruments_hgrec_configs/hgrec_{}_{}/".format(MECHANISM_NAME, V102_INJECTION_MODE),
)

"""纯 T5 v3e (Issue #33) — 单卡 batch=256 lr=1e-4 复现 pureT5_4e5abe valid_R@10=0.1083.
...
当前变体默认值 (Issue #33 v3e — 复现 Issue #55/v2 pureT5_4e5abe 2026-08-03 valid_R@10=0.1083):
...
本 v3e fork 是单卡 batch=256 LR=1e-4 ES=20 NUM_WORKERS=0 (用户授权改 framework 2026-08-09).
...
NUM_EPOCHS = 200  # Issue #33 v3e (2026-08-09): 用户授权改 framework 复现 pureT5_4e5abe valid_R@10=0.1083. 配置 = 单卡 batch=256 lr=1e-4 200ep ES=20 NUM_WORKERS=0 (Issue #55/v2 2026-08-03 真值 0.1083, ckpt 已丢失).
EARLY_STOP = 20  # Issue #33 v3e (2026-08-09): pureT5_4e5abe 原 ES=20 (Issue #55/v2 docstring line 13).
EVAL_INTERVAL = 5  # Issue #33 v3e (2026-08-09): 跟 v77/pureT5_4e5abe 历史配置一致每 5 epoch 评估.
BATCH_SIZE = 256  # Issue #33 v3e (2026-08-09): pureT5_4e5abe 原 batch=256 (单卡), NOT DDP 4 卡 per-rank 256 (vs v77 batch=1024 DDP=4*256).
INFER_SIZE = 96  # Issue #33 v3e (2026-08-09): pureT5_4e5abe 原 INFER_SIZE=96 单卡 (vs v77 INFER_SIZE=256 DDP per-rank 64).
SEED = 42
LR = 1e-4  # Issue #33 v3e (2026-08-09): pureT5_4e5abe 原 LR=1e-4 (单卡 batch=256 配套), vs v77 LR=4e-4 (DDP batch=1024 配套).

"""纯 T5 v3e lr=4e-4 (Issue #37) — v3e 单卡 lr=1e-4 修复 DDP LR 配比.
...
当前变体默认值 (Issue #37 v3e+lr4e-4 — 修复 Issue #36 DDP LR 配比错误):
  NUM_EPOCHS=200, EARLY_STOP=20, BATCH_SIZE=256, INFER_SIZE=96,
  SEED=42, LR=4e-4, MAX_LEN=20, NUM_WORKERS=0, STAGE3_BF16=True,
  TORCH_COMPILE=False.

vs Issue #36 v3e (DDP LR=1e-4 欠学习 NO-GO test 0.0912):
  - 本 fork LR=4e-4 (4× 缩放, 配 DDP batch=1024 = v4 SOTA 配比)
  - 期望 test_R@10 估 0.105-0.115 (vs v4 SOTA 0.1031 / v85h 0.1042)

vs common/stage3/stage3_train_pure_t5.py (v77/v85 配置): DDP 4 卡 batch=1024 LR=4e-4 ES=10 NUM_WORKERS=2.
本 v3e lr4e-4 fork 是 DDP 4 卡 batch=1024 LR=4e-4 ES=20 NUM_WORKERS=0 (用户授权改 framework 2026-08-09, Issue #36 NO-GO 后修复).
...
NUM_EPOCHS = 200  # Issue #37 v3e+lr4e-4 (2026-08-09): 修复 Issue #36 DDP LR 配比错误. 配置 = DDP 4 卡 batch=1024 lr=4e-4 200ep ES=20 (v4 SOTA 配比).
EARLY_STOP = 20  # Issue #37 v3e+lr4e-4 (2026-08-09): 跟 v3e 一致 ES=20.
EVAL_INTERVAL = 5  # Issue #37 v3e+lr4e-4 (2026-08-09): 跟 v3e 一致每 5 epoch 评估.
BATCH_SIZE = 256  # Issue #37 v3e+lr4e-4 (2026-08-09): per-rank batch, 全局 = 4*256 = 1024 (vs v3e 单卡 batch=256).
INFER_SIZE = 96  # Issue #37 v3e+lr4e-4 (2026-08-09): per-rank, 跟 v3e 一致.
SEED = 42
LR = 4e-4  # Issue #37 v3e+lr4e-4 (2026-08-09): 修复 Issue #36 配比错误. DDP batch=1024 (4×) → LR=4e-4 (4× 缩放), 与 v4 SOTA 配比一致.
...
MAX_LEN = 20
NUM_WORKERS = 0  # Issue #33 v3e (2026-08-09): pureT5_4e5abe 原 NUM_WORKERS=0 (Issue #55/v2 docstring line 13, 单卡无 DDP).

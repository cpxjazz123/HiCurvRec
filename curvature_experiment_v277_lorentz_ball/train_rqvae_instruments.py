...
import modules.hyperbolic as _hyp  # v277: Lorentz ball manifold 路由
_hyp.USE_LORENTZ_BALL = True  # v277: True → 所有 _expmap0_t / _logmap0_t 等走 Lorentz 公式
...
# v277 NOVEL: Lorentz ball manifold 替换 (R36n c, Nickel & Kiela 2018)
# 论文支撑: "Learning Continuous Hierarchies in the Lorentz Model of Hyperbolic Geometry" ICML 2018
# 机制: modules/hyperbolic.py 中 _expmap0_t / _logmap0_t / _mobius_add_t / _transport_between_t / _poincare_distance_t
# 全部走 Lorentz 公式 (D-dim input 内部 lift 到 D+1-dim Lorentz point, 算完 drop x_0 返回 D-dim).
# 接口不变 (RqVae 不知道 D vs D+1), 训练脚本 import hyperbolic 模块后 set USE_LORENTZ_BALL=True.
USE_LORENTZ_BALL = True                   # v277 启用 Lorentz ball manifold 替换

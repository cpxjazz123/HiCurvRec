...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "hdc_v328"  # v328 NOVEL: Hyperbolic Distance-Weighted Commit (HDC, R36n e 几何变换全新子方向). top-K=3 最近码 → inverse-distance softmax 加权 (β=2.0) → 切空间 Karcher 均值 → expmap 回 ball. 取代 v282 midpoint commit (单码 α=0.5) + v327 Möbius EMA (alpha=0.05 silent no-op 因 Taylor 一阶近似退化). 旧 v316_fixed baseline 备份在 /home/wlia0047/hj82_scratch2/wenyu/backup_curvature_v316_fixed/critical_artifacts/.

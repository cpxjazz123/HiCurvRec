...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "scale_decoupled_gamma_fix_v109"  # ← v109 = v99 R36o audit-mandated BUG_FIX 第 3 轮 (R36o 3 阶段 C 要求). v99 SD_GAMMA_MAX=1024 太松 + SD_USE_COMMITMENT=False → γ≈40 让 x_scaled 远超 codebook norm, 全部层 collapse (codes=6/4/5/256). 修复: γ_max=5.0 (sane upper) + commitment=True (梯度稳定).

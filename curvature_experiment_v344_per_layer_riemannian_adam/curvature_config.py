...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v344_r1_per_layer_riem_adam_l2_adamw"  # ← v344 R1 (2026-09-03): Round 0 v344 全 3 层 Per-Layer RA 触发 L2 utility 71.5% FAIL (-9.4% vs baseline 80.9%), 根因: L2 input residual norm 极小 (≈ 0.07) + Per-Layer RA 强更新让 L2 codebook 进一步收束. Round 1 cascade-aware 修复: 只对 L0/L1 用 Per-Layer Riemannian Adam, L2 用回 baseline AdamW. 历史类似: v321 Möbius EMA L2=68.8%, v337 MGC L2=16%, 都是 R36n (d)/(e) 类几何优化器在 L2 触发 collapse. R36p v3.13 诊断 Round 1, 期待 L2 utility 回到 baseline 80.9%+. baseline = v318_v317_cyclic_c test_R@10=0.11791237113402062 (R51+ 2 RUN PASS, commit 64841e5).

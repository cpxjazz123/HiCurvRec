...
def parse_args():
    ...
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[255,255,255], help='emb num of every vq (v3.12 R36 强约束: 三层完全一样 255)')
    parser.add_argument('--e_dim', type=int, default=32, help='vq codebook embedding size')
    parser.add_argument('--quant_loss_weight', type=float, default=1.0, help='vq quantion loss weight')
    parser.add_argument("--beta", type=float, default=1.0, help="Beta for commitment loss")
    parser.add_argument('--layers', type=int, nargs='+', default=[512,256,128,64], help='hidden sizes of every layer (用户指令 2026-09-04: 恢复 HG-Rec 原版 4 层 [512,256,128,64], 但 codebook 仍 3 层 [255,255,255] 同构)')

...
if __name__ == "__main__":
    ...
    ckpt_path = f"./ckpt/{dataset}/Sep-04-2026_01-11-55_beta_1.000_codebook_[255,255,255]_sk_0.000/best_collision_model.pth"
    output_path = f"./dataset/{dataset}/{dataset}_t5_rqvae_beta_0.250_codebook_[255,255,255]_4layer_sk_0.000_seed42.npy"

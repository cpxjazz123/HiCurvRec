...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "full_riemannian_adam_v91"  # ← v91: Full Riemannian Adam (Stage 1 端 FINAL R36h FALSIFICATION) — 完整 Riemannian optimization: Euclidean grad → Riemannian grad (Poincaré scaling) → Riemannian Adam moment → Möbius expmap retraction. 保持 v87 其余配置完全不变 (F3 Spread + curriculum c + M3 Transport). R36h ceiling 7 次后 (v51/v52/v56/v67/v71/v89/v90) 第 8 次独立证据. 判定标准: R@10 > 0.11171 突破, ≤ 0.11171 正式关闭 Stage-1 几何路线.

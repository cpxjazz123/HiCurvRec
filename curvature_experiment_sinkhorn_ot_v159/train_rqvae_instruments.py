...
def main():
    ...
    model = RqVae(
        ...
        hyperbolic_distance=True,   # v159: 启用 Poincaré 距离, 让 Sinkhorn-OT 均衡分配生效 (R36n (c) manifold 几何替换 + 防 collapse)
        sk_eps=0.005,              # v159: Sinkhorn-Knopp 温度 0.005 (温和均衡, 不强制硬化分配)

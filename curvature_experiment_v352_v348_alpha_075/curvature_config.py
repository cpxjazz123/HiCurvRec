...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v352_v348_alpha_075"  # ← v352 SWEEP (2026-09-03). 在 v348 (midpoint-only baseline, α=0.5) 基础上 sweep L0 geodesic midpoint α=0.75 (slight bias toward input).

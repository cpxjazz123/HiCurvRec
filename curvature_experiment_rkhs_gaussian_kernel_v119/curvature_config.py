...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "rkhs_gaussian_kernel_v119"  # ← v119 NOVEL: RKHS Gaussian Kernel VQ (Schölkopf 2002 'Learning with Kernels'). kernel(x, c) = exp(-||x-c||²/(2σ²)) 替代 Euclidean/双曲距离 argmin. σ = RBF bandwidth heuristic. v117 HyperVQ (D=32 不可行) + v118 球面 init (L2 8/256 塌缩) R37 FAIL 后转入新方向 (kernel 距离 vs 几何距离). R36n 合规 (kernel distance = 几何变种). Stage 1 端纯几何变更. v115 baseline test_R@10=0.1129993556701031 LOCKED.

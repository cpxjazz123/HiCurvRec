...
class RqVae(nn.Module, PyTorchModelHubMixin):
    def __init__(
        ...
        distance_mode: QuantizeDistance = QuantizeDistance.L2,  # RqVae → Quantize distance mode (L2/COSINE/GAUSSIAN_RBF)
        ...
        self.layers = nn.ModuleList(
            modules=[
                Quantize(
                    ...
                    sk_eps=sk_eps,
                    sk_iters=sk_iters,
                    distance_mode=distance_mode,  # v119 RKHS Gaussian kernel VQ (None 时 fallback L2, R7 兼容)

...
DISTANCE_MODE = QuantizeDistance.GAUSSIAN_RBF  # v119 NOVEL: 替代 HG-Rec 双曲距离
RBF_BANDWIDTH = 1.0  # v119 RBF σ: bandwidth heuristic scale parameter. 1.0 = 单位距离带宽.
...
def main():
    ...
    model = RqVae(
        ...
        distance_mode=DISTANCE_MODE,  # v119 GAUSSIAN_RBF

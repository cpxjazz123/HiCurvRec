...
# v351 SWEEP: hardcoded module-level α for L0 geodesic midpoint commit
# α=0.25: slight bias toward codeword (slightly less than midpoint)
MIDPOINT_ALPHA = 0.25
        ...
        for li, layer in enumerate(self.layers):
            ...
            if self.gate_M2_intrinsic:
                ...
                if self.use_geodesic_midpoint_commit and self.midpoint_layer_mask[li]:
                    ...
                    # v351 SWEEP: α parameterizes geodesic commitment depth

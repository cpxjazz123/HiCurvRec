...
MAHALANOBIS_INIT_VAR = 1.0  # v120 C-RVQ 兼容 fallback (未启用 per-layer 时)
MAHALANOBIS_INIT_VAR_PER_LAYER = [0.5, 2.0, 2.0]  # v122 NOVEL: L0/L1/L2 异方差 init_var
...
def main():
    ...
    model = RqVae(
        ...
        mahalanobis_init_var=MAHALANOBIS_INIT_VAR,  # v120 C-RVQ fallback (未启用 per-layer 时)
        mahalanobis_init_var_per_layer=MAHALANOBIS_INIT_VAR_PER_LAYER,  # v122 NOVEL: per-layer 异方差 init_var

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "per_layer_mahalanobis_v122"  # ← v122 NOVEL: Per-layer Mahalanobis init_var (L0=0.5, L1=2.0, L2=2.0). v120 全局 init_var=1.0 → v122 per-layer 异方差, 捕捉 cascade RQ-VAE 输入异方差性 (L0 raw encoder norm 大, L1/L2 residual norm 小). R36n+R36b 合规 (per-layer 异方差 + 几何变种). v120 baseline test_R@10=0.11183150773195877 LOCKED.

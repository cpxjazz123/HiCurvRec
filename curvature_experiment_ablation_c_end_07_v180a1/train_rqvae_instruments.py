...
# === v180 ablation: Per-Layer c_end curriculum stagger (R36n (b)) ===
...
def main():
    ...
    # v180 ablation: Per-Layer c_end curriculum stagger (c_start 统一, c_end per-layer 阶梯)
    if USE_PER_LAYER_C_END:
        ...
        for li, layer in enumerate(model.module.layers):
            ...
            if rank == 0:
                print(f"  [v180-ab] L{li} override: c_end={per_layer_c_end[li]:.3f}", flush=True)

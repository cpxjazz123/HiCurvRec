...
def main():
    ...
    model = RqVae(
        ...
        gate_M2_intrinsic=True,   # v356 ABLATION: 启用 M2 (midpoint 路径)
        gate_M3_transport=False,  # v356 ABLATION: 关 M3 (排除 transport)
        hyperbolic_distance=True, # v356 ABLATION: 启用双曲距离

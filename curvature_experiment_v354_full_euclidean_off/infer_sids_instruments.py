...
def main():
    ...
    model = RqVae(
        ...
        gate_M2_intrinsic=False,  # v354 ABLATION: 关 M2 (欧氏 fallback)
        gate_M3_transport=False,  # v354 ABLATION: 关 M3 (RQ-VAE-Recommender 无 transport)
        hyperbolic_distance=False, # v354 ABLATION: L2 距离 argmin (RQ-VAE-Recommender 等价)

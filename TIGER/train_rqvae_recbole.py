...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_sid", type=Path, default=DATA_DIR / "sids_for_hgrec_recbole.npy")
    parser.add_argument("--output_json", type=Path, default=DATA_DIR / "item_sids_recbole.json")
    parser.add_argument("--checkpoint", type=Path, default=DATA_DIR / "rqvae_recbole_best.pth")

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "cyclic_v316_v318"  # ← v318 NEW: cyclic curriculum c(t) + v316_fixed anisotropy std-matching (R36n a+f 联合). cyclic curriculum = c_min+(c_max-c_min)|sin(πt/T)|, c 在训练中按 SGDR 震荡, 让 RQ-VAE 在不同曲率空间学习. v316_fixed 提供 spread_loss + anisotropy_loss 正则, 防止 collapse. 比较 baseline = v316_fixed (test_R@10=0.11606).

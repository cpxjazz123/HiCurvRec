...
用法:
  python3 taskA/stage4/taskA_stage4_beam20_reeval.py \
      --device cuda:0 --n 1000 --tag issue28_diag \
      --ckpt "taskA/stage3/taskA_stage3_issue24_precheck_v3.py@taskA/stage3/taskA_stage3_issue28_gate2_diag/best_adapter.pt"
"""
import argparse
...
DEFAULT_WRAPPER = "/fs04/ar57/wenyu/GeneRec/taskA/stage3/taskA_stage3_issue24_precheck_v3.py"

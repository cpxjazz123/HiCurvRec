...
V74_EVAL_CONFIG = {
    # ── 路径 (硬编码, 与 Stage3 产物目录配套) ──
    "ckpt_path": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/issue138_v74_stage3/HG_Rec_best.pth",
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/taskA_stage2_v15_capmatch_1000ep/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/issue138_v74_stage3/eval",
    ...
    # ── HAB Stage2 ckpt 必须指向 v15 capmatch 1000ep (与 SID 同源) ──
    # 否则 HAB bias 的 Dbar 矩阵跟训练时不匹配 → test_R@10 严重低估

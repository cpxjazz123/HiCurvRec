...
def main():
    ...
    kappa_vq_fix_path = f"{PROJECT}/taskA/stage2/_archive/taskA_stage2_kappa_vq_fix.py"
    kappa_sync_path = f"{PROJECT}/taskA/stage2/_archive/taskA_stage2_kappa_sync.py"
    ...
    with open(out_path, "w") as f:
        json.dump({
            ...
            "stage3_kappa_handling": {
                "file": "taskA/stage3/_archive/taskA_stage3_kappa_scale_recontinue.py",

...
USE_HYPERBOLIC_CONTRASTIVE = True          # v283: 启用 Poincaré distance margin contrastive loss
HYPER_CONTRASTIVE_MARGIN = 0.5             # v283: margin m (Poincaré ball radius ≈ 1.41, m=0.5 = 35% radius)
HYPER_CONTRASTIVE_N_NEG = 8                # v283: K=8 negative samples per anchor
HYPER_CONTRASTIVE_WEIGHT = 0.05            # v283: λ=0.05 (vs commit_weight=1.0, 5% 权重防 commit loss 被压垮)
...
def main():
    ...
    model = RqVae(
        ...
        use_hyperbolic_contrastive=USE_HYPERBOLIC_CONTRASTIVE,  # v283: hyperbolic contrastive commit loss
        hyper_contrastive_margin=HYPER_CONTRASTIVE_MARGIN,
        hyper_contrastive_n_neg=HYPER_CONTRASTIVE_N_NEG,
        hyper_contrastive_weight=HYPER_CONTRASTIVE_WEIGHT,
    ).to(device)

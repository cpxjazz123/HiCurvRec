...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "heterogeneous_spread_v329"  # ← v329 NOVEL: per-layer异质 SPREAD_LOSS_MARGIN [3.0,2.5,2.0] + ANISOTROPY_TARGET_STD [2.5,2.0,1.5] (R36n b+f). 在 v316_fixed (anisotropy + spread) 基础上让 L0 最 spread, L2 最 compact. L0 输入 norm 最大 (~1.0) → margin 最大; L2 输入 norm 最小 (~0.01) → margin 最小. v316 baseline 已 R36h ceiling 第 54 次验证 (test_R@10=0.11606 +2.23% vs v282).

"""v5 test eval: HG_Rec + LorentzEmbedding (sinh-based expmap) + HAB → test.parquet beam=20."""
import os
import sys
import torch
import numpy as np
...
from model.hg_rec_curv_v5 import HG_Rec_Curv_V5
from model.hab import precompute_hab_distances, make_layer_id_lut, HABModule, install_hab

CKPT = sys.argv[1] if len(sys.argv) > 1 else \
    "./ckpt/Instruments/Aug-18-2026_v5/HG_Rec_curv_hab_v5_epoch_0.pth"

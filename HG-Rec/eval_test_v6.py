"""v6 test eval: HG_Rec + LorentzEmbedding (no HAB) → test.parquet beam=20."""
import os
import sys
import torch
...
CKPT = sys.argv[1] if len(sys.argv) > 1 else \
    "./ckpt/Instruments/Aug-18-2026_v6/HG_Rec_curv_v6_epoch_0.pth"
...
def main():
    ...
    print("NO HAB — pure LorentzEmbedding model.")

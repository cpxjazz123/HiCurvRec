...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v212_cdl_entropy"  # ← v212 NOVEL: per-layer c_end ladder [0.5, 0.6, 0.7] + Codebook Diversity Loss (CDL 软分配熵 + dead-code penalty). 7 rounds ladder/size R36p FAIL 后改走 loss-side diversity bonus. R36c Round 8. R36n (b) + (f). v120 baseline test_R@10=0.11183 LOCKED.

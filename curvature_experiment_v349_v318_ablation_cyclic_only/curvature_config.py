...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v349_v318_ablation_cyclic_only"  # ← v349 ABLATION (2026-09-03). 在 v318 baseline 基础上**关 geodesic midpoint commit (USE_GEODESIC_MIDPOINT_COMMIT=False), 保留 cyclic c(t) curriculum**, 验证 R36n (a) Cyclic 单独贡献. baseline = v318_v317_cyclic_c (test_R@10=0.11791237113402062). 消融矩阵: A1=v318 full / A2=v348 (midpoint only) / A3=v349 (cyclic only) / A4=HG-Rec baseline. **(e) Midpoint 单独贡献 = A1 - A3**.

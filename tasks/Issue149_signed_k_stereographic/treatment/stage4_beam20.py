...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue149_signed_k_stereographic/treatment/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae
...
V74_EVAL_CONFIG = {
    ...
    "ckpt_path": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue149_signed_k_stereographic/treatment/stage2/HG_Rec_best.pth",
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue149_signed_k_stereographic/treatment/stage2/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue149_signed_k_stereographic/treatment/stage2/eval",
    "expected_sid_sha": "",
    ...
    "hab_stage2_ckpt": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue149_signed_k_stereographic/treatment/stage2/hrqvae_kappa_sync.ckpt",
    # 任务标签
...
def main():
    ...
    if HAB_ENABLED:
        ...
        for stats in stats_list:
            ...
            assert stats["sym_err"] < 1e-5, f"L{stats['layer']} 对称误差 {stats['sym_err']} >= 1e-6"

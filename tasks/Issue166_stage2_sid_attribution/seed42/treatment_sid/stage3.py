...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue162_layer_curvature_mixer/treatment/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue162_layer_curvature_mixer/treatment")  # R44 baseline 自包含: from _lib import hyperbolic_attention_bias
...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue162_layer_curvature_mixer/treatment")  # R44 baseline 自包含
...
V74_CONFIG = {
    ...
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue166_stage2_sid_attribution/stage2_new/treatment/stage2/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue166_stage2_sid_attribution/seed42/treatment_sid/stage2",
    "expected_sid_sha": "",
    ...
    "hab_stage2_ckpt": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue166_stage2_sid_attribution/stage2_new/treatment/stage2/hrqvae_kappa_sync.ckpt",
...
EVAL_INTERVAL = 1  # R41b: 每个 epoch 都必须 eval  # Issue #141 v85q (2026-08-09): 用户指示 EVAL_INTERVAL=5 (匹配 v77/v85p 历史配置, 每 5 epoch 评估). 当前 + NUM_WORKERS=2 单 epoch 7s, EI=5 省 2s/epoch (-28%). v77 实际配置就是 EI=5.
...
def main():
    ...
    # Issue #166: 无注入 Stage3 (M4 OFF) — 用 GenRecDataset, A/B 唯一差异是 SID 来源
    ...
    valid_ds = GenRecDataset(
        ...
        codebook_size=CODEBOOK_SIZE, max_len=MAX_LEN)
    if is_main:
        log(f"n_train(no-windowed)={len(train_ds)} n_valid={len(valid_ds)}")

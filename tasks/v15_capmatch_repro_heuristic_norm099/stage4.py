...
V74_EVAL_CONFIG = {
    # ── 路径 (硬编码, 实时 Stage3 产物) ──
    "ckpt_path": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v15_capmatch_repro_heuristic_norm099/HG_Rec_best.pth",
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v15_capmatch_repro_heuristic_norm099/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v15_capmatch_repro_heuristic_norm099/eval",
    ...
    "hab_stage2_ckpt": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v15_capmatch_repro_heuristic_norm099/hrqvae_kappa_sync.ckpt",
    # ── 任务标签 (verdict 写入用) ──

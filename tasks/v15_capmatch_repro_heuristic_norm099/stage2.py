...
ITEM_EMB_NPY = "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v15_capmatch_repro_heuristic_norm099/item_emb_v15repro_u32.npy"  # Stage 1 实时产出 (R_MODE=fixed, R_MAX=1.0, r=1+2e-4*randn norm≈1.0000 std=0.0002 unique=16, parquet SHA=006aefbeff3385c07ee8e8a03c2a8d286c629bb203efe143bea15fed33bd5839, 匹配 v15 训练输入分布)

...
sys.path.insert(0, os.path.join("/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0000", "_lib"))  # R44 baseline 自包含
...
GATE_M1_ROUTER = False   # per-item curvature router (L1/L2 prefix-conditioned c)
GATE_M2_INTRINSIC = False  # 内在 Möbius residual 减法
GATE_M3_TRANSPORT = False  # 跨层曲率传递

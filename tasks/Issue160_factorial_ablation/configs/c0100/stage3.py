...
sys.path.insert(0, "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0100/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae
sys.path.insert(0, "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0100")  # R44 baseline 自包含: from _lib import hyperbolic_attention_bias
...
sys.path.insert(0, "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0100")  # R44 baseline 自包含
...
V74_CONFIG = {
    ...
    "sid_npy": "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0100/stage2/sid_output.npy",
    "product_dir": "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0100/stage2",
    "expected_sid_sha": "",
    ...
    "hab_stage2_ckpt": "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c0100/stage2/hrqvae_kappa_sync.ckpt",

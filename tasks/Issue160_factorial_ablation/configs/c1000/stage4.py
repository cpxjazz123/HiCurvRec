...
import sys as _sys
_sys.path.insert(0, "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c1000")  # R44 baseline 自包含
...
V74_EVAL_CONFIG = {
    ...
    "ckpt_path": "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c1000/stage2/HG_Rec_best.pth",
    "sid_npy": "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c1000/stage2/sid_output.npy",
    "product_dir": "/fs04/ar57/wenyu/GeneRec/tasks/Issue160_factorial_ablation/configs/c1000/stage2/eval",
    "expected_sid_sha": "",
...
STAGE4_SINGLE_CARD = True  # 单卡并行评估 (R42 例外)
...
def main():
    ...
    model = HG_Rec(CONFIG)
    # Issue #159/#160: 曲率状态注入 (与 Stage3 训练一致, M4 gate 控制)

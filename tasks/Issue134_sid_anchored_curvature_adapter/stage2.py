...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue134_sid_anchored_curvature_adapter/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae + hyperbolic_attention_bias + poincare_*

ITEM_EMB_PARQUET = "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue134_sid_anchored_curvature_adapter/stage1/item_emb.parquet"  # R44 baseline 自包含: Stage1 实时产物
N_ITEMS = 9922
EMB_DIM = 768
N_HIERARCHIES = 3
...
PRODUCT_DIR = Path(os.environ.get("BASELINE_STAGE2_PRODUCT_DIR",
                                  "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue134_sid_anchored_curvature_adapter/stage2"))  # R44 baseline 自包含: 产物写 baseline/stage2/
...
class KappaAwareVectorQuantization(nn.Module):
    ...
    def get_c(self) -> torch.Tensor:
        ...
        Issue #134 (2026-08-12): baseline ceiling 验证 — 回退到 baseline c=exp(κ) 路径.
        ...
        if CURV_PRIOR:
            # Issue #134: 回到 baseline c=exp(κ) 路径 (回退 #129 tanh 变更)

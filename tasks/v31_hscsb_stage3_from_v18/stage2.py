#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v31_hscsb_stage3_from_v18 Stage 2: 沿用 v15 capmatch Stage2 (HRQVAE baseline).

Issue #108 (2026-08-10): HSCSB 不改 Stage2 (Stage2 已穷尽, 与 HSCSB 完全正交).
  ...
  - HSCSB 直接复用 Stage2 ckpt 的 3 层 codebook + per-layer κ
"""
import os
import subprocess
...
def main():
    ...
    print(f"[v31_hscsb_stage3_from_v18/stage2] cmd={' '.join(cmd)}")

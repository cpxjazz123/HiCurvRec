...
from intrinsic_curvature_quantizer import IntrinsicCurvatureHRQVAE, C_MIN, C_MAX
...
def main():
    ...
    model = IntrinsicCurvatureHRQVAE(
    ...
    if rank == 0:
        ...
        verdict = {
            "issue": "#157",
            "arm": "treatment",
            "source": "Issue #157 intrinsic curvature residual + DDP 4 卡",
            "world_size": world,
            "n_epochs": N_EPOCHS,

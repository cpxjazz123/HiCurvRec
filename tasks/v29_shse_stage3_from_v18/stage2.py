#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v29_shse_stage3_from_v18 Stage 2: 沿用 v15 capmatch Stage2 (HRQVAE baseline).

Issue #106 (2026-08-10): SHSE 不改 Stage2 (Stage2 已穷尽, 与 SHSE 完全正交).
  - 输出: taskA/_history/v15_capmatch_full_repro_kappamax_fix/hrqvae_kappa_sync.ckpt
  - 输出: taskA/_history/v15_capmatch_full_repro_kappamax_fix/sid_output.npy
...
def main():
    ...
    print(f"[v29_shse_stage3_from_v18/stage2] cmd={' '.join(cmd)}")

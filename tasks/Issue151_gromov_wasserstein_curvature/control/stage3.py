...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue151_gromov_wasserstein_curvature/control/_lib")  # Issue150 taskA control self-contained _lib
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue151_gromov_wasserstein_curvature/control")  # from _lib import hyperbolic_attention_bias
...
V74_CONFIG = {
    # 路径 (Issue #150 taskA control: 实时 Stage2 产物)
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue151_gromov_wasserstein_curvature/control/stage2/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue151_gromov_wasserstein_curvature/control/stage2",
    "expected_sid_sha": "1e652b2215da4d19e7fad383e3a889f23542247e9eba4367d69edc5be4a02f30",
    # HAB 三改动 (Issue #138 v74)
    "hyperbolic_attn_bias": True,
    "enable_residual_hab": True,
    "hab_lambda_max": 0.20,
    "residual_alpha_init": -20.0,
    "hab_stage2_ckpt": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue151_gromov_wasserstein_curvature/control/stage2/hrqvae_kappa_sync.ckpt",

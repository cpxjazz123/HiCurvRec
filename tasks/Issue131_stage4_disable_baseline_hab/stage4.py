...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab")  # R44 baseline 自包含: from _lib import hyperbolic_attention_bias
...
import sys as _sys
_sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab")  # R44 baseline 自包含
...
V74_EVAL_CONFIG = {
    ...
    "ckpt_path": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab/stage2/HG_Rec_best.pth",
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab/stage2/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab/stage2/eval",
    "expected_sid_sha": "",
    ...
    "hab_stage2_ckpt": "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab/stage2/hrqvae_kappa_sync.ckpt",
    # 任务标签
...
def main():
    ...
    if HAB_ENABLED:
        ...
        print(f"[Issue #64] hyperbolic_attn_bias enabled for eval "
              ...
              flush=True)
        # Issue #131 (2026-08-12): Stage4 评估端 ablation — 强制 HAB baseline lambda_raw=0 让 HAB 完全失效.
        # 验证 Issue129 ckpt 在 HAB 完全失效下的 test_R10, 揭示 baseline HAB lambda_raw 是否实际伤害 test.
        # Issue #130 验证 per-head lambda_h_raw 对 test 贡献 0% (bit-identical); 本 issue 验证 baseline HAB.
        # 这是 Stage4 评估端变更, Stage1/2/3 沿用 Issue129 实时产物 (R40 豁免).
        with torch.no_grad():
            hab_module.lambda_raw.data.fill_(0.0)
            print(f"[Issue #131] HAB baseline lambda_raw frozen to 0 for eval ablation "
                  f"(per-head lambda_h_raw still loaded)", flush=True)

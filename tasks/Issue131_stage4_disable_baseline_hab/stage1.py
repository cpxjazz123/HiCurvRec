...
OUTPUT_PARQUET = Path("/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue131_stage4_disable_baseline_hab/stage1/item_emb.parquet")  # R44 baseline 自包含: 产物写 baseline/stage1/
TAG = "baseline"

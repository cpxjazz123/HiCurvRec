...
def install_hab(hg_rec, hab_module, layer_id_lut_array):
    ...
    try:
        ...
        # transformers >= 4.47 移除了 create_bidirectional_mask (T5Stack 改用内部 causal mask 逻辑,
    ...
    def hab_encoder_forward(self, input_ids=None, attention_mask=None, inputs_embeds=None,
        ...
        # transformers 4.40.2 兼容: T5Stack.forward 不接受 curvature/response (generate model_kwargs 透传)

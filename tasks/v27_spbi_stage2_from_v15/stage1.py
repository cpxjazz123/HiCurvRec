#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v27_spbi_stage2_from_v15 Stage 1: skip — 沿用 v15 capmatch preprocessed 数据.

v27 是 Issue #104 "Stage2 SPBI Stratified Poincaré Ball Initialization", 只改 Stage2 codebook init.
Stage1 数据预处理完全沿用 v15 capmatch, 不重跑.
"""
print("[v27_spbi_stage2_from_v15/stage1] SKIP — 沿用 v15 capmatch 产物")

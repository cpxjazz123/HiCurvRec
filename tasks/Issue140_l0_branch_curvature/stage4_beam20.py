...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue140_l0_branch_curvature/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue140_l0_branch_curvature")  # R44 baseline 自包含: from _lib import hyperbolic_attention_bias
...
V74_EVAL_CONFIG = {
    ...
    # 任务标签
    "tag": "issue140_l0_branch_curvature",
}

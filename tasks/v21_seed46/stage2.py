#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Stage 2 stub: 共享 taskA_stage2_v15_capmatch_1000ep SID, 本任务不重新跑 Stage 2."""
...
def main():
    ...
    print(f"[stage2] using existing Stage 2: {STAGE2_DIR}")
    print(f"[stage2] sid_output.npy exists, size={sid_npy.stat().st_size}, expected SHA={SID_SHA}")

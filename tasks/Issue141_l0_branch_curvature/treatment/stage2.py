...
# -*- coding: utf-8 -*-
"""
Issue #141 [treatment/B] Stage2 L0 codeword-specific bounded curvature (A/B 对照 treatment 臂)
...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue141_l0_branch_curvature/treatment/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae + hyperbolic_attention_bias + poincare_*

ITEM_EMB_PARQUET = "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue141_l0_branch_curvature/treatment/stage1/item_emb.parquet"  # R44 baseline 自包含: Stage1 实时产物
N_ITEMS = 9922
EMB_DIM = 768
N_HIERARCHIES = 3
...
L0_SHARED_CURVATURE = False         # Issue #141 treatment (B 臂): 64 codeword 独立曲率
...
PRODUCT_DIR = Path("/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue141_l0_branch_curvature/treatment/stage2")  # R44 baseline 自包含: 产物写本任务 stage2/

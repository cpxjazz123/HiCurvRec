#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v9 Stage 4: v15 历史 Stage 2 + v74 HAB ckpt 评估.

R30 合规: 顶部硬编码.
R31 合规: common/stage4/stage4_eval_pure_t5.py source of truth.
R34 合规: tasks/v9_v15_history_reuse/stage4.py.
"""
import subprocess
...
V74_EVAL_CONFIG = {
    ...
    "product_dir": "/fs04/ar57/wenyu/GeneRec/taskA/_history/taskA_stage2_v15_capmatch_1000ep_v9_stage3/eval",
...
def main():
    print(f"[v9/stage4] cwd={REPO}")
    print(f"[v9/stage4] ckpt={V74_EVAL_CONFIG['ckpt_path']}")
    print(f"[v9/stage4] sid={V74_EVAL_CONFIG['sid_npy']}")
    cmd = build_cmd()
    print(f"[v9/stage4] cmd={' '.join(cmd)}")

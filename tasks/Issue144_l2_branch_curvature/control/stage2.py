...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue144_l2_branch_curvature/control/_lib")  # R44 baseline 自包含: HG_Rec/dataset/dataloader/utils/fsq_quantizer/hrqvae + hyperbolic_attention_bias + poincare_*

ITEM_EMB_PARQUET = "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue144_l2_branch_curvature/control/stage1/item_emb.parquet"  # R44 baseline 自包含: Stage1 实时产物
N_ITEMS = 9922
EMB_DIM = 768
N_HIERARCHIES = 3
...
SHARED_LAYERS = [True, True, True]       # control (A 臂): L0/L1/L2 全共享
...
PRODUCT_DIR = Path("/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue144_l2_branch_curvature/control/stage2")  # R44 baseline 自包含: 产物写本任务 stage2/
...
def run_gate1(item_emb: torch.Tensor, device) -> dict:
    ...
    # ── check 2: control (A) L2 为共享曲率 — 扰动唯一 θ_2 影响全部 256 列 (A 臂语义) ──
    torch.manual_seed(2024)
    ...
    with torch.no_grad():
        pert_model.vq_layers[2].theta += 0.5  # 扰动共享 θ_2
    ...
    all_256_changed = len(changed_cols) == 256
    report["checks"]["check2_single_branch"] = {
        "perturbed_layer": 2,
        "shared_curvature": True,
        "changed_cols_count": len(changed_cols),
        "all_256_cols_changed": all_256_changed,
    }
    c2_ok = all_256_changed

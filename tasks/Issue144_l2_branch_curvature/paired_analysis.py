...
TASK = Path("/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue144_l2_branch_curvature")
...
no_shortcut = not audit_b["l2_scale_shortcut_detected"]
...
verdict = {
    ...
    "gate3": {
        ...
        "scale_shortcut_B": audit_b["l2_scale_shortcut_detected"],
...
with open(TASK / "issue144_verdict.json", "w") as f:
    json.dump(verdict, f, indent=2, default=str)
md = f"""# Issue #144 Verdict: {decision}
...
- B 无尺度捷径: {not audit_b['l2_scale_shortcut_detected']}
- TARGET (R@10 > 0.1020): {target_reached}
"""
open(TASK / "issue144_verdict.md", "w").write(md)
print(f"\n-> issue144_verdict.md/json: {decision}")

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v15 Stage 4 (beam=20): v74 HAB + LR=1e-3 单 ckpt 评估. 用户硬约束 2026-08-09.

约束 (R35):
  - 必须只能使用单 checkpoint (v15_highLR HG_Rec_best.pth)
...
R34 合规: tasks/v15_pureT5_highLR/stage4_beam20.py.
"""
import subprocess
...
CONFIG = {
    ...
    "product_dir": "/fs04/ar57/wenyu/GeneRec/taskA/_history/v15_highLR_beam20_eval",
...
def main():
    ...
    cmd = [PYTHON, "-u", "common/stage4/stage4_eval_pure_t5_v85p_4layer.py",
           ...
           "--tag", CONFIG["tag"],
           "--hyperbolic_attn_bias",  # v15 用了 HAB, 必须传
           "--enable_residual_hab",
           "--beam_size", CONFIG["beam_size"]]
    print(f"[v15/stage4_beam20] cmd={' '.join(cmd)}")

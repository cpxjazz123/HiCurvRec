#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v34_hres_stage3_from_v18 Stage 2: 沿用 v15 capmatch Stage2 (HRQVAE baseline).

Issue #111 (2026-08-10): HRes 不改 Stage2 (沿用 v33/v32 教训 + v15 capmatch baseline 稳定).
  ...
  - HRes 直接复用 Stage2 ckpt 的 per-layer κ 作单曲率 mean
"""
import os
import subprocess
...
def main():
    ...
    print(f"[v34_hres_stage3_from_v18/stage2] cmd={' '.join(cmd)}")

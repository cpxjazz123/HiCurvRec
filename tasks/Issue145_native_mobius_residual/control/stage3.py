...
# ──────────────────────────────────────────────────────────────
# DDP 启动配置 (R42: Issue #145 arm A 使用 GPU 0,1; B 使用 GPU 2,3 避免冲突)
STAGE3_DDP_CONFIG = {
...
V74_CONFIG = {
    ...
    "hab_stage2_ckpt": "/fs04/ar57/wenyu/GeneRec/tasks/Issue145_native_mobius_residual/control/stage2/hrqvae_kappa_sync.ckpt",

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v18 Stage 3: v15 配方 + seed=43 (vs v15 seed=42)."""
import os
import subprocess
...
V18_CONFIG = {
    ...
    "product_dir": "/fs04/ar57/wenyu/GeneRec/taskA/_history/v18_multi_seed43_stage3",
    ...
    "tag": "v18_multi_seed43",
}

PATCH_SEED_OLD = "SEED = 42"
PATCH_SEED_NEW = "SEED = 43  # v18 (2026-08-09): multi-seed averaging diversity"
...
def main():
    ...
    print(f"[v18/stage3] cmd={' '.join(cmd)}")
    try:

...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue147_prefix_conditioned_curvature/_lib")  # R44 baseline 自包含: 引用本任务 _lib (复制 baseline/_lib)
...
OUTPUT_PARQUET = Path("/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue147_prefix_conditioned_curvature/stage1/item_emb.parquet")  # R44 baseline 自包含: 产物写本任务 stage1/
TAG = "baseline"

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v18_branch_curvature Stage 4 (beam=20): 单 ckpt 评估. R35+R36 合规.
"""
import subprocess
...
CONFIG = {
    "tag": "v18_branch_curvature_beam20",
    ...
    "product_dir": "/fs04/ar57/wenyu/GeneRec/taskA/_history/v18_branch_curvature_beam20_eval",
...
def main():
    ...
    cmd = [PYTHON, "-u", "common/stage4/stage4_eval_pure_t5_v85p_4layer.py",
           ...
           "--enable_residual_hab",
           # 注: branch_curvature 已在 Stage 3 学到 hab_module 中, Stage 4 不需要额外 flag
           "--beam_size", CONFIG["beam_size"]]
    print(f"[v18_branch_curvature/stage4_beam20] cmd={' '.join(cmd)}")

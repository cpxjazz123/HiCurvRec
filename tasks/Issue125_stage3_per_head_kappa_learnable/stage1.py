...
OUTPUT_PARQUET = Path("/home/wlia0047/ar57/wenyu/GeneRec/tasks/Issue125_stage3_per_head_kappa_learnable/stage1/item_emb.parquet")  # R44 baseline 自包含: 产物写 baseline/stage1/
TAG = "baseline"

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v22_hab_attn_entropy_from_v18 Stage 4 (beam=20): 单 ckpt 评估. R35+R36+R37 合规.
"""
import subprocess
...
CONFIG = {
    "tag": "v22_hab_attn_entropy_beam20",
    "ckpt_path": "/fs04/ar57/wenyu/GeneRec/taskA/_history/v22_hab_attn_entropy_stage3/HG_Rec_best.pth",
    "sid_npy": "/fs04/ar57/wenyu/GeneRec/taskA/_history/taskA_stage2_v15_capmatch_1000ep/sid_output.npy",
    "product_dir": "/fs04/ar57/wenyu/GeneRec/taskA/_history/v22_hab_attn_entropy_beam20_eval",
...
def main():
    ...
    print(f"[v22_hab_attn_entropy_from_v18/stage4_beam20] cmd={' '.join(cmd)}")

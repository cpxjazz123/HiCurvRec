#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v14 Stage 4 (beam=20): 纯 T5 (no HAB) 单 ckpt 评估. 用户硬约束 2026-08-09.

约束:
  - 必须只能使用单 checkpoint (v14 HG_Rec_best.pth)
  - beam_search=20 (用户强约束, 不用 30/50)
...
R34 合规: tasks/v14_pureT5_noHAB/stage4_beam20.py.
"""
import subprocess
...
CONFIG = {
    ...
    "product_dir": "/fs04/ar57/wenyu/GeneRec/taskA/_history/v14_pureT5_beam20_eval",
...
def main():
    ...
    print(f"[v14/stage4_beam20] cmd={' '.join(cmd)}")

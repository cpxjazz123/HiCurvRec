...
V74_CONFIG = {
    # ── 路径 (硬编码, 实时 Stage2 产物) ──
    # Stage2 实时 product_dir = v8b_relstruct_lambda_20/, sid_output.npy 由 Stage2 训练产出
    "sid_npy": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v8b_relstruct_lambda_20/sid_output.npy",
    "product_dir": "/home/wlia0047/ar57/wenyu/GeneRec/taskA/_history/v8b_relstruct_lambda_20",

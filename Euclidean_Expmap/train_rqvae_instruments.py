...
启动:
  CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=29500 \
      /home/wlia0047/ar57/wenyu/GeneRec/Euclidean_Expmap/train_rqvae_instruments.py
...
=== 双曲机制 M1: Expmap (本目录 Euclidean_Expmap 唯一启用) ===
encoder 输出后接 expmap0 投影到 Poincare ball; L2 距离不变.
"""
import json
import os
import sys
...
# R47 imports — Euclidean_Expmap (M1 机制目录, 本目录 modules)
...
OUT_DIR = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_m1_expmap"

import os
import sys
# 跳过 transformers TF 路径 (Keras 3 兼容性问题, 避免激活 activations_tf 触发 tf_keras import)
os.environ["USE_TF"] = "0"
os.environ["TRANSFORMERS_NO_ADVISORY_WARNINGS"] = "1"

# 把当前脚本所在目录加入 sys.path 最前 (R44/R47: 任务目录自包含,
# 让 `from data...` / `from modules...` / `from evaluate...` 解析到本目录,
# 而非 HuggingFace 的同名 site-packages 包)
...
def train(
    ...
    BEST_CKPT_PATH = "out/decoder/m1_expmap_instruments/best_ckpt.pt"

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v348_v318_ablation_midpoint_only"  # ← v348 ABLATION (2026-09-03). 在 v318 baseline 基础上**关 cyclic c(t) curriculum (USE_CYCLIC_CURVATURE=False), 保留 geodesic midpoint commit L0**, 验证 R36n (e) Geodesic Midpoint 单独贡献. 等价于 v317 Midpoint-Only 配置. 论文支撑: R36n (e) 几何变换 variant #3 — commit 路径走测地线中点 mid = exp_0(0.5·log_0(res) + 0.5·log_0(emb), c=1.0). baseline = v318_v317_cyclic_c (test_R@10=0.11791237113402062). 消融矩阵: A1=v318 full / A2=v348 (midpoint only) / A3=v349 (cyclic only) / A4=HG-Rec baseline. **(a) Cyclic 单独贡献 = A1 - A2**.

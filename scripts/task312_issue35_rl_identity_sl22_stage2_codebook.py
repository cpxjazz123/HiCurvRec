"""Task #312 / Issue #35 — Stage 2 Sinkhorn 5 iter 推断 on r_l identity + s_l=[2,2,2].

r_l=[1,1,1] identity + s_l=[2,2,2] (跟 #30 [0.1,1,10]+[2,2,2] 对比)
"""
import collections
import glob
import logging
...
def main():
    ...
    output_path = f"/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/{dataset}/{dataset}_t5_hrqvae_issue35_rl_identity_sl22.npy"
    device = torch.device("cuda:0")

    log = logging.getLogger("task312_issue35_gate2")
    ...
    # Dedup 4th digit (跟 task301 一致)
    # Parse indices directly from code list

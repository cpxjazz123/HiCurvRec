...
def main():
    ...
    # Task #233 (2026-07-27): 方向 I c=10 训练时用 kappa_mode='exp_global' + theta_init=log(10),
    # 这些参数 ckp['args'] 里都有, 必须透传, 否则模型定义无 theta → load_state_dict 报 unexpected key.

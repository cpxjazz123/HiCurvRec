#!/usr/bin/env bash
# Step 3 v4: w_div=100.0 (极大, 强制方向散开) + kill 禁用.
...
OUTDIR=$REPO/products/m_arm/m_radius_spread_step3_50ep_wdiv100
...
echo "==== Step 3 v4: w_div=100.0 + kill 禁用 (GPU=$GPU) ===="
cd "$REPO"
LR_LOG_R=10.0 \
DISABLE_USAGE_KILL=1 \
CUDA_VISIBLE_DEVICES=$GPU \
TRITON_CACHE_DIR=/home/wlia0047/.triton/cache_radius_spread_step3_wdiv100 \
PYTHONUNBUFFERED=1 \

"""Task #137 v2 Stage 2 — κ_max=0.1 A-arm codebook generation.

Fork of task137_stage2_codebook_free_curv.py, hardcoded for v2 ckpt path
(products/task137_v2/train/arm_A_M1_kappa0.1/) and curv0.1 output suffix.
"""
import collections
import json
import logging
...
def main():
    dataset = "Instruments"
    ckpt_path = "/home/wlia0047/ar57/wenyu/GeneRec/products/task137_v2/train/arm_A_M1_kappa0.1/best_loss_model.pth"
    output_path = f"/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/{dataset}/{dataset}_t5_hrqvae_poincare_curv0.1.npy"
    ...
    meta = {
        'task': 'Task #137 v2 A-arm Stage 2',
        'ckpt_path': ckpt_path,

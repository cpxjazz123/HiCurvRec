#!/bin/bash
# task9_stage3_l5w256.sh — task11 L=5, W=256 Stage 3 TIGER 训练
#
# GPU 分配: GPU 3 (cuda:3) — Stage 2.2 inference 完成后腾出
# 输入: Stage 2.2 dedup SID tensor (shape: (6, 11924))
# num_hierarchies=6 (L=5 + 1 dedup column)
# 输出: <run_ts>/checkpoints/...
#
# 启动命令:
#   cd /fs04/ar57/wenyu/GeneRec/GRID
#   bash /home/wlia0047/ar57/wenyu/GeneRec/GRID/task_artifacts/scripts/task9_stage3_l5w256.sh
...
CUDA_VISIBLE_DEVICES=3 python -m src.train \
    ...
    2>&1 | tee /home/wlia0047/ar57/wenyu/GeneRec/GRID/task_artifacts/scripts/logs/task9_s3_l5w256.log
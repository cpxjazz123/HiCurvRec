...
_t470_path = os.path.join(PROJECT, "scripts/task470_issue177_gate3_a_recontinue.py")
...
CKPT_PATH = f"{PROJECT}/products/task472_issue179_direction_a_gate4_200ep/adapter_200ep.pt"
DEVICE = "cuda"
D_MODEL = 128
MAX_LEN = 4
PAD_TOKEN = 0
...
def main():
    ...
    # Save
    out_dir = "products/task472_issue179_direction_a_gate4_200ep"

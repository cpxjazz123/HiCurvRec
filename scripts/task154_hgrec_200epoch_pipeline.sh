#!/bin/bash
# Task #154 — HG-Rec 200 epoch ablation (paper Table 6 Instruments 行)
# 2026-07-24 (用户 2026-07-24 提议: 验证 paper 200 epoch 是否解释 R@10 -22.4% 差距)
#
# 唯一改动 vs Task #84 baseline: --epochs 1000 → --epochs 200 (paper-faithful)
# 其他 recipe 完全一致 (R11.3 决策: 单一变量原则)
#
# R7 GPU: GPU 2 (空闲)
# 预计: Stage 1 ~10 min (vs 25 min for 1000 epoch) + Stage 2 ~3 min + Stage 3 ~70 min + Stage 4 ~30 sec = ~1.5h

set -eo pipefail

export CUDA_VISIBLE_DEVICES=2
export PYTHONPATH=/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec:${PYTHONPATH:-}
export TRITON_CACHE_DIR=/home/wlia0047/.triton/cache_task154

source /apps/anaconda/2024.02-1/etc/profile.d/conda.sh
conda activate /home/wlia0047/ar57_scratch/wenyu/genrec_env

LOG_DIR=/home/wlia0047/ar57/wenyu/GeneRec/logs/task154
mkdir -p "$LOG_DIR"

CKPT_DIR=/home/wlia0047/ar57/wenyu/GeneRec/products/task154/ckpt
mkdir -p "$CKPT_DIR" /home/wlia0047/ar57/wenyu/GeneRec/products/task154

TS=$(date +%Y%m%d_%H%M%S)
LOG_FILE="$LOG_DIR/200ep_stage1_${TS}.log"

cd /home/wlia0047/ar57/wenyu/GeneRec/HG-Rec

echo "===== [Task #154] HG-Rec 200 epoch Stage 1 launched at $(date) =====" | tee "$LOG_FILE"
echo "唯一改动: --epochs 1000 → 200 (paper-faithful)" | tee -a "$LOG_FILE"
...
# Stage 1: HRQ-VAE training (200 epoch)
...
STAGE1_EXIT=$?
echo "===== [Task #154] Stage 1 exit code: $STAGE1_EXIT at $(date) =====" | tee -a "$LOG_FILE"
...
# Stage 2: SID codebook (同 Task #153 写法)
...
output_path = '/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/Instruments/Instruments_t5_hrqvae_poincare_200ep.npy'

ckpt = torch.load(ckpt_path, weights_only=False, map_location='cpu')
args = ckpt['args']
state_dict = ckpt['state_dict']

print(f'[Stage 2] β={args[\"beta\"]}, num_emb_list={args[\"num_emb_list\"]}, epoch={ckpt.get(\"epoch\", -1)}')
...
STAGE2_EXIT=$?
echo "===== [Task #154] Stage 2 exit code: $STAGE2_EXIT at $(date) =====" | tee -a "$LOG_FILE"
...
echo "✅ Task #154 Stage 1+2 完成. Stage 3+4 待运行 (见 task154_hgrec_stage3_train.sh)" | tee -a "$LOG_FILE"
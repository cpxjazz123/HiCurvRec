"""Task #300 Issue #29 Gate 2 — Stage 2 Sinkhorn 推断.
Issue #29 ckpt (per-layer K_l=[128,64,32]) → (N, 4) SID .npy 给 Stage 3 T5.

Usage:
    python3 scripts/task300_issue29_gate2_stage2_codebook.py
"""
import collections
import glob
import logging
...
def main():
    """Issue #29 Gate 2 Sinkhorn 5 iter inference."""
    dataset = "Instruments"
    ckpt_base = "/home/wlia0047/ar57/wenyu/GeneRec/products/task300/hrqvae_issue29_gate1"
    ...
    output_path = f"/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/{dataset}/{dataset}_t5_hrqvae_issue29_per_layer_k.npy"
    device = torch.device("cuda:0")

    log = logging.getLogger("task300_issue29_gate2")
    ...
    log.info("=" * 60)
    log.info("Issue #29 Gate 2 verification:")

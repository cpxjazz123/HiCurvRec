...
# 输入: products/task209/t5small_A3/.../HG_Rec_best.pth (Stage 3 训练产出)
# 输出: verdicts/task209_phase2c_A3_metrics.json
# GPU 2 (R7: A0/A3 分配到独立卡)
#
# 跟 #181 Stage 4 唯一区别: ckpt path 改 task209/t5small_A3/
...
export TRITON_CACHE_DIR=/home/wlia0047/.triton/cache_task209_phase2c_A3_stage4
...
BEST_CKPT=$(ls /home/wlia0047/ar57/wenyu/GeneRec/products/task209/t5small_A3/Instruments/*/HG_Rec_best.pth 2>/dev/null | head -1)
if [ -z "$BEST_CKPT" ] || [ ! -f "$BEST_CKPT" ]; then
    echo "❌ Best ckpt MISSING under products/task209/t5small_A3/" | tee $LOG_FILE
    exit 1
fi
RESULT_JSON=/home/wlia0047/ar57/wenyu/GeneRec/verdicts/task209_phase2c_A3_metrics.json
...
CODE_PATH = '/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/Instruments/Instruments_t5_rqvae_task209_A3.npy'

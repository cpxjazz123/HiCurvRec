...
if __name__ == "__main__":
    dataset = "Instruments"
    ckpt_base = "/home/wlia0047/ar57/wenyu/GeneRec/products/task184/hrqvae_product_manifold"
    ...
    output_path = f"/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/{dataset}/{dataset}_t5_rqvae_product_manifold.npy"
    ...
    model = HRQVAE(in_dim=data.dim,
                  ...
                  # Task #184 Phase 1a: product manifold 参数
                  radii=getattr(args, 'radii', None),
                  rho_reg_weight=getattr(args, 'rho_reg_weight', 0.0),
                  ...
                  beta_radial=getattr(args, 'beta_radial', 1.0))

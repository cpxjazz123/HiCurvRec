...
if __name__ == "__main__":
    ...
    # Task #179 (Idea 1): dual-branch hyperbolic T5 — κ_max controls long branch curvature bound
    parser.add_argument('--kappa_max', type=float, default=2.0, help='Max curvature for long hyperbolic branch (HG_Rec_DualBranch only, κ=κ_max*tanh(θ))')

#!/bin/bash
# task4_p0_mixed_curvature_s3.sh — Phase 2 P0.3 Stage 3: TIGER training
# 输入: P0.3 Stage 2.2 SID tensor (custom Mixed-Curvature output)
# 输出: best_tiger_*.ckpt
set -euo pipefail
...
echo "[task58 P0.3 s3] SID: $SID_PATH"
...
CUDA_VISIBLE_DEVICES=0 python -m src.train \
    ...
    id=task58_p0_mixed_curvature_s3 \
    2>&1 | tee /home/wlia0047/ar57/wenyu/GeneRec/GRID/task_artifacts/scripts/logs/task4_p0_mixed_curvature_s3.log

echo "[done] ckpt at /home/wlia0047/ar57/wenyu/GeneRec/GRID/logs/train/runs/task58_p0_mixed_curvature_s3/checkpoints/"
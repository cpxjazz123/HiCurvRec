#!/usr/bin/env bash
# Step 3 v6: w_div=100 + 新增 w_angular=10 (cos_std > 0.3 显式 pen) + kill 禁用.
...
OUTDIR=$REPO/products/m_arm/m_radius_spread_step3_50ep_wdiv100_wangular
...
echo "==== Step 3 v6: w_div=100 + w_angular=10 (cos_std > 0.35 强制) + kill 禁用 (GPU=$GPU) ===="
echo "log → $LOG"
cd "$REPO"
LR_LOG_R=10.0 \
DISABLE_USAGE_KILL=1 \
CUDA_VISIBLE_DEVICES=$GPU \
TRITON_CACHE_DIR=/home/wlia0047/.triton/cache_radius_spread_step3_v6 \
PYTHONUNBUFFERED=1 \

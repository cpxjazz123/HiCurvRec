"""Task #304 D6 ablation Arm B — Gate 2 Stage 2 Sinkhorn 推断 (s_l only)
Arm B ckpt (r_l=[1,1,1] + s_l=[2,2,2] + c_k_range) → (N, 4) SID .npy 给 Stage 3 T5.

Usage:
    python3 scripts/task304_d6_gate2_stage2_codebook_arm_b.py
"""
import collections
import glob
import logging
...
def main():
    """Task #304 Arm B Gate 2 Sinkhorn 5 iter inference."""
    dataset = "Instruments"
    ckpt_base = "/home/wlia0047/ar57/wenyu/GeneRec/products/task304/d6_arm_b_gate1"
    ...
    output_path = f"/home/wlia0047/ar57/wenyu/GeneRec/HG-Rec/dataset/{dataset}/{dataset}_t5_hrqvae_d6_arm_b_s_only.npy"
    device = torch.device("cuda:0")

    log = logging.getLogger("task304_arm_b_gate2")
    ...
    log.info("=" * 60)
    log.info("Task #304 Arm B Gate 2 verification:")

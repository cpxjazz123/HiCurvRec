...
R42: 必须 torchrun --nproc_per_node=4 (DDP 4 卡) 或 兼容单卡 fallback.
...
每 10k 全球 step rank 0 保存一次 ckpt; 训完保存 final.
"""
import json
import os
import sys
...
# R53: NFS cache warm-up: force attribute refresh for the dataset dir
import time as _time
for _ in range(10):
    try:
        _d = os.path.dirname(EMB_NPY)
        _ = os.listdir(_d)

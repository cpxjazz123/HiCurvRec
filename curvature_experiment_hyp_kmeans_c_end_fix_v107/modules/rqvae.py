...
class RqVae(nn.Module, PyTorchModelHubMixin):
    def __init__(
        ...
        # v100: Hyperbolic K-Means init (Poincaré dist + Fréchet mean)
        hyperbolic_kmeans_init: bool = False,
        hyperbolic_kmeans_c: float = 0.5,
    ) -> None:
        self._config = locals()
        ...
        # v100 flags
        self.hyperbolic_kmeans_init = hyperbolic_kmeans_init
        self.hyperbolic_kmeans_c = float(hyperbolic_kmeans_c)
        ...
        self.layers = nn.ModuleList(
            modules=[
                Quantize(
                    ...
                    # v100: Hyperbolic K-Means init
                    hyperbolic_kmeans_init=hyperbolic_kmeans_init,
                    hyperbolic_kmeans_c=hyperbolic_kmeans_c,
                )

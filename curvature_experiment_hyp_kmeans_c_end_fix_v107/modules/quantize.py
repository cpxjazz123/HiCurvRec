...
from init.hyperbolic_kmeans import hyperbolic_kmeans_init_
...
class Quantize(nn.Module):
    def __init__(
        ...
        hyperbolic_kmeans_init: bool = False,    # v100: Hyperbolic K-Means init (Poincaré dist + Fréchet mean)
        hyperbolic_kmeans_c: float = 0.5,        # v100: 曲率 for K-Means (与 c_train 对齐)
        ...
        self.hyperbolic_kmeans_init = hyperbolic_kmeans_init  # v100
        self.hyperbolic_kmeans_c = hyperbolic_kmeans_c  # v100
    ...
    def _kmeans_init(self, x) -> None:
        if self.hyperbolic_kmeans_init:
            hyperbolic_kmeans_init_(self.embedding.weight, x=x, c=self.hyperbolic_kmeans_c)
        else:

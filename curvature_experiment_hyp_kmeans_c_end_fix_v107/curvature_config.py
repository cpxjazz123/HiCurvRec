...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "hyp_kmeans_c_end_fix_v107"  # ← v107 = v100 hyperbolic KMeans c=0.05 (Euclidean!) BUG_FIX 为 c=C_END=0.7. R36o v3.7 强制 BUG_FOUND MEDIUM-HIGH 置信度修复. v100 实施时把 c 用错 (C_START=0.05), Poincaré ball 半径 1/sqrt(0.05)=4.47 ≈ Euclidean, hyperbolic KMeans 退化为 Euclidean KMeans. 修复为 c=0.7 (训练中后期主导 c) 让 Poincaré KMeans 真正激活. Stage 1 端纯几何变更 (R36+R36n 合规), R36h ceiling #15 后 bug-fix 尝试, 期望 codebook 初始位置真正在 hyperbolic ball → SIDs 与 baseline 不同 → 潜在突破 0.11171.

...
def main():
    ...
    model = RqVae(
        ...
        # v107 BUG_FIX: v100 错用 c=C_START=0.05 (Poincaré ball 半径 4.47 ≈ Euclidean,
        # 整个 hyperbolic KMeans 退化为 Euclidean KMeans). R36o v3.7 audit 强制修复.
        # 修复: c=C_END=0.7 (训练中后期主导 c), 让 Poincaré KMeans 真正激活.
        hyperbolic_kmeans_init=True,
        hyperbolic_kmeans_c=C_END,
    ).to(device)

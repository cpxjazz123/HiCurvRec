...
# === 训练硬约束 (R30/R43): 250k global steps (v368 fix: 2023 2.5x items need 2.5x steps) ===
# v318_amazon2023 baseline MAX_GLOBAL_STEPS=100_000 (effective 1031 epoch/items vs 2018 2564)
# v368 fix: 250_000 steps → effective ~2577 epoch/items (与 2018 等价, R37 期望 test_R@10 0.0245 → 0.06+)
NUM_EPOCHS = 10000               # 语义参考
MAX_GLOBAL_STEPS = 250_000       # 250k steps ≈ 18 分钟@4卡
CKPT_EVERY = 25_000              # 每 25k 全球 step 保存一份 ckpt (避免太多中间产物)

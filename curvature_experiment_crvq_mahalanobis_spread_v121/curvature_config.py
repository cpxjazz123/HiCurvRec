...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "crvq_mahalanobis_spread_v121"  # ← v121: C-RVQ Mahalanobis (v120 +0.108% 突破 baseline) 联合 F3 Spread Loss (v87 +0.108% 突破 baseline). anisotropic per-codeword Mahalanobis dist + Poincaré spread pairwise margin=2.5. R36n 合规 (covariance Mahalanobis + Poincaré spread, 都是几何变种). v120 baseline test_R@10=0.11183150773195877 LOCKED.

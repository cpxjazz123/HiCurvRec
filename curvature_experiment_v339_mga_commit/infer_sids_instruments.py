...
def main():
    ...
    model = RqVae(
        ...
        # v339: MGA commit (Möbius ADD) — 与 MGC 互斥, MGC 关
        use_mobius_gyrovector=False,
        mobius_gyrovector_alpha=0.5,
        use_mobius_addition=True,  # v339: enable MGA
        mobius_addition_gamma=0.5,  # v339: γ=0.5 (与 Stage 1 训练一致)
    ).to(device)

...
class RqVae(nn.Module, PyTorchModelHubMixin):
    def __init__(
        ...
        # commit = res ⊕ (γ ⊗ emb), γ=0.5 fixed. 与 MGC (v337) 数学结构不同.
        use_mobius_addition: bool = False,
        mobius_addition_gamma: float = 0.5,
    ) -> None:
        self._config = locals()
        ...
        self.use_mobius_addition = bool(use_mobius_addition)  # v339
        self.mobius_addition_gamma = float(mobius_addition_gamma)  # v339
        ...
        self.layers = nn.ModuleList(
            modules=[
                Quantize(
                    ...
                    use_mobius_addition=use_mobius_addition,  # v339: Möbius Gyrovector ADDITION commit
                    mobius_addition_gamma=mobius_addition_gamma,  # v339: γ MGA weight

...
启动:
  CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=29500 \
      /home/wlia0047/ar57/wenyu/GeneRec/Euclidean_PoincareDist/train_rqvae_instruments.py
...
=== 双曲机制 M2: PoincareDist (本目录 Euclidean_PoincareDist 唯一启用) ===
Quantize distance 用 Poincare 距离 (frozen κ=1.0); L2 不再用于 codebook assignment.
"""
import json
import os
import sys
...
sys.path.insert(0, "/home/wlia0047/ar57/wenyu/GeneRec/Euclidean_PoincareDist")
...
OUT_DIR = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_m2_poincare_dist"
...
# === 双曲机制参数 (硬编码 R30/R43, M2) ===
HYPERBOLIC_MECHANISM = "poincare_dist"
INIT_CURVATURE = 1.0
QUANTIZE_DISTANCE_MODE = QuantizeDistance.POINCARE
...
def main():
    ...
    model = RqVae(
        ...
        vae_init_curvature=INIT_CURVATURE,

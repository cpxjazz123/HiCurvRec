...
def main():
    ...
    tokenizer = SemanticIdTokenizer(
        ...
        # M2 PoincareDist: 用 M2 RQ-VAE 权重 (含 poincare_distance.c buffer)
        rqvae_weights_path="/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_m2_poincare_dist/rqvae_final.pt",
    ...
    if accelerator.is_main_process:
        ...
        # 持久化结果
        import json
        out_path = "out/decoder/m2_poincare_dist_instruments/test_final.json"

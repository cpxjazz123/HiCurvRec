...
# v67 B1: 用 Stage 1 v67 B1 Per-Layer Schedule 训练产物
CKPT = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_v67_b1_per_layer/rqvae_final.pt"
OUT_NPY = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/sids_v67_b1_per_layer.npy"
...
def main():
    ...
    # v67 B1: 启用 per-layer schedule (与 train 一致, inference 走 schedule 终点)
    ...
    if V67_B1_ENABLED:
        ...
        print(f"[v67 B1] enabled per-layer schedule at inference", flush=True)

...
| 2 | DIGER FrqUD beam=50/100 (饱和) | KDD'24 | **0.1127** | 0.0831 | +10.1% | **+2.5%** ✓ | **超目标 (饱和)** |
| 3 | DIGER SDUD | KDD'24 | 0.1096 | 0.0828 | +7.0% | -0.4% | 接近目标 |
| 4 | **DECOR** | SIGIR'26 | **0.1157** | 0.0859 | +13.0% | **+5.2%** ✓ | **超目标** |
| 5 | DECOR beam=100 (饱和) | SIGIR'26 | **0.1157** | 0.0859 | +13.0% | **+5.2%** ✓ | **超目标 (饱和)** |

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v226_sphere_anchor"  # ← v226 NOVEL: v225 per-layer max_norm L0=26.6% R36p FAIL. v226 改用 Sphere Anchor (球壳约束), L0 codeword 强制落在 norm∈[0.3, 0.5] 球壳, 解决 retraction (max clip only) 不触发的 collapse 根因. R36n 合规: (c) manifold 几何 + (e) 几何变换 (球面投影). Stage 1 端纯几何变更. R36p v3.10 utility ≥ 90% 硬约束.

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "radial_distortion_v93"  # ← v93 = v92 Radial Activation (A) + Relational Distortion Supervision (D). R92-Diagnostic + v92 smoke Gate 4 fail 驱动: L_dist 直接优化 per-layer D_l^ref (量化前 residual pair dist) 与 D_l^(c_l) (量化后 codeword pair dist with c_l) 的 Spearman corr 接近 1. R36 + R36n 合规.

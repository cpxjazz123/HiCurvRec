...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "radial_sigma_fix_v108"  # ← v108 = v97 BUG_FIX (R36o audit HIGH 置信 BUG_FOUND). v97 RADIAL_SIGMA_RATIO=0.05 太小 → L1/L2 collapse 到 1 code (codes=25/1/1/256 at 10k step). 修复为 σ(t)=0.30·μ(t) (6x 多样性) 让 radial spread 真正激活. Stage 1 端纯几何变更 (R36+R36n 合规), R36o v3.7 audit-mandated 第 2 轮 bug-fix 尝试.

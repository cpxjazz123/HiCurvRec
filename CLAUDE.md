...
> HG-Rec (Hyperbolic RQ-VAE + Differential-Length Codebook + T5) 流水线复现工作目录, **基线 Task #84 valid R@10=0.1267 / test R@10=0.1024 (Musical_Instruments 9922 items)**, **当前 curvature_base baseline = v270 cyclic curriculum + M2 commit loss + M3 transport, test_R@10=0.1130396262886598 (R36h ceiling 二次突破 +0.32% vs v262, 2026-08-28 promoted)**.

---

## 最新测试结果 (2026-08-28 v270 promoted 为新 baseline + 历史 SOTA, beam=20)

| 流水线 | 状态 | valid R@10 | valid NDCG@20 | **test R@10** | test R@20 | test NDCG@20 | ckpt |
|---|---|---|---|---|---|---|---|
| **v270 cyclic curriculum + M2 commit loss + M3 transport** (新 baseline, 2026-08-28 promoted from curvature_experiment_v270_cyclic_curriculum, R36n (a) cyclic c(t) = c_min + (c_max-c_min)|sin(πt/T)| (SGDR Loshchilov & Hutter 2017) + v262 M2 commit loss + M3 transport 联合, c 震荡 0.05↔0.7 (T=25000 步 ≈ 4 个完整周期), 关 USE_CURRICULUM_CURVATURE, **R36h ceiling 二次突破 +0.32% vs v262 0.11268**, 2 RUN 字符级完全一致 0.1130396262886598, utility 254/245/248 健康, Stage 3 best ckpt E117, n_eval=24832, R51+ 6 确定性约束全开) | ✅ R37 PASS (新 baseline) | — | **0.0978 (best valid ndcg@20)** | **0.1130396262886598** | **0.1450144974226804** | **0.0907523951579615** | `curvature_base/out/decoder/instruments_hgrec_configs/hgrec_cyclic_curriculum_v270/best_ckpt.pt` |

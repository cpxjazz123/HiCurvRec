...
def train(
    ...
    # v82 R36c fix: hgrec_code_path 同样强制覆盖为 curvature_config.SIDS_NPY
    # (否则 gin binding 失败 → hgrec_code_path="" → fallback baseline v19 SIDs → v82 SIDs 训练无效 → R@10=0)
    from curvature_config import SIDS_NPY as _SIDS_NPY
    hgrec_code_path = _SIDS_NPY

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v213_dead_code_reset"  # ← v213 NOVEL: per-layer c_end ladder [0.5, 0.6, 0.7] + Dead-code reset (每 500 步, 用 batch encoder 输出重新初始化 usage=0 死码). 8 rounds ladder/CDL R36p FAIL 后改走显式 codebook 干预 (R36c Round 9). R36n (b) + (e) + (f). v120 baseline test_R@10=0.11183 LOCKED.

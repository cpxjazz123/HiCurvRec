# Task #35 — phonism/genrec TIGER 200 epochs × seed=2024 (run #4/4)

> **任务目的**: 与 Task #32/#33/#34 并行跑，验证 phonism 200 epochs 上限在多 seed 下稳定
> **完成日期**: (in progress)
> **状态**: 🟡 待启动

> 同系列任务: Task #32 (seed=42), Task #33 (seed=123), Task #34 (seed=7)
> GPU 分配: cuda:3
...
- [ ] 启动 (cuda:3)
- [ ] 训练完成 + test eval
- [ ] verdict 写入 `verdicts/task35_phonism_seed2024_result.md`

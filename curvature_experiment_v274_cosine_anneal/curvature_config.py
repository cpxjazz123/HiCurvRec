...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "cosine_anneal_v274"  # ← v274 NOVEL: R36o 阶段 D 新方向 — SGDR 余弦退火 (Loshchilov & Hutter 2017) c(t) = c_min + 0.5*(c_max-c_min)*(1+cos(πt/T)). 与 v270 的 |sin| 不同: cos shape 更平滑无尖峰, peak 在 t=0 → trough 在 t=T (annealing 方向). v271/v272/v273 三轮 c 范围/T 微调全部 R37 FAIL (R36h ceiling 强化), 故转 shape 变种. c 范围 (0.05, 0.7) + T=25000 保持. 保留 USE_M2_INTRINSIC=True / USE_M3_TRANSPORT=True / USE_FIXED_CURVATURE=True / DISTANCE_MODE=L2 / hyperbolic_distance=True / sk_eps=0.05.

...
from data.instruments import RawMusicalInstruments
...
DATASET_NAME_TO_RAW_DATASET = {
    ...
    RecDataset.INSTRUMENTS: RawMusicalInstruments,
}
...
class SeqData(Dataset):
    def __init__(
        ...
        *args,
        ...
        force_process: bool = False,
        dataset: RecDataset = RecDataset.ML_1M,
        split: Optional[str] = None,  # NEW: 显式指定 split ("train"/"valid"/"test"), None 时按 is_train 推断
        **kwargs,
    ) -> None:

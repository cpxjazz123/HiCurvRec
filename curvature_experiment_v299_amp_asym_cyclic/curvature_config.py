...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "amp_asym_cyclic_v299"  # ← v299 NOVEL: R36n (a)+(b) 联合方向 — per-layer amplitude-asymmetric cyclic curriculum. 论文支撑: SGDR (Loshchilov & Hutter 2017) + multi-scale curriculum. 三层 c_min/c_max 各异: L0 [0.05, 0.7] (baseline), L1 [0.1, 0.9] (略扩展), L2 [0.05, 1.5] (深度双曲). 让不同层在不同曲率幅度震荡, 增加 Stage 1 RQ-VAE 学习多样性. R36h ceiling 第 35 次验证. 目标: test_R@10 > 0.1135631443298969 (v282 baseline).

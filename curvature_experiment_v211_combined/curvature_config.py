...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v211_combined"  # ← v211 NOVEL: per-layer c_end ladder [0.5, 0.6, 0.7] + per-layer codebook size [320, 256, 192] 双机制组合 (R36c Round 7). v207 ladder (c 容量差异化) + v210 size (code 容量差异化). 期望 L0 死码突破. R36n (b) per-layer 异质 capacity (c + size 双维度). v120 baseline test_R@10=0.11183 LOCKED.

...
def main():
    ...
    model = RqVae(
        ...
        gate_M2_intrinsic=True,   # v355 ABLATION: 启用 M2 (midpoint 路径)
        gate_M3_transport=False,  # v355 ABLATION: 关 M3 (无 transport)
        hyperbolic_distance=True, # v355 ABLATION: 启用双曲距离

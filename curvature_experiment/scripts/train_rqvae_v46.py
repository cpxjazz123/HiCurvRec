...
OUT_DIR = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_v46_cend_05_m2"
...
C_END = 0.5  # v46: c_end 0.7→0.5 缓和曲率调度                               # v19: 最终 c 1.0→0.7 (缓和曲率调度, R36 框架级变更)
...
USE_M2_INTRINSIC = True  # v46: M2+M3 联合启用                  # C28: 关 M2 (M2 + M3 联合 NO-GO, 回 C28 单 M3)

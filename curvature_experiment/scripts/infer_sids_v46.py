...
CKPT = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_v46_cend_05_m2/rqvae_final.pt"
OUT_NPY = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/sids_v46_cend_05_m2.npy"
...
def main():
    ...
    # Save HG-Rec format (9922, 4) [sid0/1/2 + 0 PAD] → dataset/Instruments/Instruments_v46_sids_for_hgrec.npy
    sids_hgrec = np.zeros((n_items, 4), dtype=np.int64)
    sids_hgrec[:, :3] = sids
    HGREC_NPY = "/home/wlia0047/ar57/wenyu/GeneRec/curvature_experiment/dataset/Instruments/Instruments_v46_sids_for_hgrec.npy"
    np.save(HGREC_NPY, sids_hgrec)
    print(f"[save hgrec] {HGREC_NPY}: shape={sids_hgrec.shape}, dtype={sids_hgrec.dtype}")

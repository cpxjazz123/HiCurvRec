...
OUT_DIR = "/home/wlia0047/hj82_scratch2/wenyu/rqvae_dataset/instruments/rqvae_out_c22tcu_c28_v13"
...
USE_TCU = True                   # v13: 启用 C22 TCU (联合 C28)
...
def main():
    ...
    model = RqVae(
        ...
        use_tcu=USE_TCU,           # v13: C22 TCU 联合 C28 启用
        tcu_alpha=TCU_ALPHA,
        tcu_eta=TCU_ETA,

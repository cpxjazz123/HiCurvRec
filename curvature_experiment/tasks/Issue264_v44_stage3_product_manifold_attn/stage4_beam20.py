"""v44 Stage 4 wrapper — DDP 4 卡 test eval (beam=20, R35 禁 Borda).

依赖 Stage 3 产物: out/decoder/instruments_hgrec_v44/best_ckpt.pt
注意: v44 Stage 3 训练时已经注入 product manifold bias, Stage 4 加载 ckpt 后
...
LOG_PATH = os.path.join(LOG_DIR, "curvature_exp_v44_stage4.log")
os.makedirs(LOG_DIR, exist_ok=True)

BEST_CKPT = os.path.join(MAIN_DIR, "out/decoder/instruments_hgrec_v44/best_ckpt.pt")
...
env = os.environ.copy()
env["FORCE_HGREC"] = "1"
env["USE_PRODUCT_MANIFOLD"] = "1"  # v44 创新开关 (Issue264): Stage 4 加载时也启用 product manifold bias

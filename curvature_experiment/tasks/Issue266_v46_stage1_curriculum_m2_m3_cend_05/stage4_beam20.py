"""v46 Stage 4 wrapper — DDP 4 卡 test eval (beam=20, R35 禁 Borda).

依赖 Stage 3 产物: out/decoder/instruments_hgrec_v46/best_ckpt.pt
"""
import os
import subprocess
import sys
...
LOG_PATH = "/home/wlia0047/hj82_scratch2/wenyu/claude_tmp/curvature_exp_v46_stage4.log"
os.makedirs(os.path.dirname(LOG_PATH), exist_ok=True)

BEST_CKPT = os.path.join(MAIN_DIR, "out/decoder/instruments_hgrec_v46/best_ckpt.pt")

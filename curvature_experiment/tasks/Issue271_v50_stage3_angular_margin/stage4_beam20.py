"""v50 Stage 4 wrapper — DDP 4 卡 test eval (beam=20, R35b 严格分片).

依赖 Stage 3 产物: out/decoder/instruments_hgrec_v50/best_ckpt.pt
Stage 4 端完全复用 v19 baseline test eval 路径 (评估 v50 Stage 3 端 Inter-Layer Angular Margin 是否传递到 test_R@10).
"""
import os
import subprocess
import sys
...
LOG_PATH = "/home/wlia0047/hj82_scratch2/wenyu/claude_tmp/curvature_exp_v50_stage4.log"
os.makedirs(os.path.dirname(LOG_PATH), exist_ok=True)

BEST_CKPT = os.path.join(MAIN_DIR, "out/decoder/instruments_hgrec_v50/best_ckpt.pt")

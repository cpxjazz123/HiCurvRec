"""v40 Stage 3 wrapper — HG-Rec T5 训练 + PoincareT5LayerNorm (DDP 4 卡).
...
Stage 3 启用 v40: use_hyp_layernorm=True → 替换 T5 所有 T5LayerNorm 为 PoincareT5LayerNorm (c=0.5).
"""
import os
import subprocess
import sys
...
LOG_PATH = os.path.join(LOG_DIR, "curvature_exp_v40_stage3.log")
...
env = os.environ.copy()
env["FORCE_HGREC"] = "1"
env["SAVE_DIR_ROOT"] = "/home/wlia0047/ar57/wenyu/GeneRec/curvature_experiment/out/decoder/instruments_hgrec_v40/"

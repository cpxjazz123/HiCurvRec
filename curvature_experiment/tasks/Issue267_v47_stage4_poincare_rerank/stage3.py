"""v47 Stage 3 wrapper — 复用 v19 baseline HG-Rec T5 训练 (DDP 4 卡, R51 seed lock).

Stage 3 完全复用 v19 baseline 路径 (HALC v2 + v16 diff schedule), 不引入任何 Stage 3 端曲率机制.
Stage 4 端会引入 Poincaré rerank (v47 唯一创新点).
"""
import os
import subprocess
import sys
...
LOG_PATH = "/home/wlia0047/hj82_scratch2/wenyu/claude_tmp/curvature_exp_v47_stage3.log"
...
env = os.environ.copy()
env["FORCE_HGREC"] = "1"
env["SAVE_DIR_ROOT"] = "/home/wlia0047/ar57/wenyu/GeneRec/curvature_experiment/out/decoder/instruments_hgrec_v47/"

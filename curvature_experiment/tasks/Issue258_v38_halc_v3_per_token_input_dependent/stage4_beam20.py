"""v38 Stage 4 wrapper — DDP 4 卡 test eval (beam=20, R35 禁 Borda).

依赖 Stage 3 产物: out/decoder/instruments_hgrec_v38/best_ckpt.pt
"""
import os
import subprocess
import sys
...
LOG_PATH = os.path.join(LOG_DIR, "curvature_exp_v38_stage4.log")
os.makedirs(LOG_DIR, exist_ok=True)

BEST_CKPT = os.path.join(MAIN_DIR, "out/decoder/instruments_hgrec_v38/best_ckpt.pt")

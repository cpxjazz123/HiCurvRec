"""v41 Stage 3 wrapper — HG-Rec T5 训练 + PoincareInputEmbedding (DDP 4 卡).
...
Stage 3 启用 v41: use_poinc_input_embed=True → 替换 T5.shared 为 PoincareInputEmbedding (c=0.5).
"""
import os
import subprocess
import sys
...
LOG_PATH = os.path.join(LOG_DIR, "curvature_exp_v41_stage3.log")
...
env = os.environ.copy()
env["FORCE_HGREC"] = "1"
env["SAVE_DIR_ROOT"] = "/home/wlia0047/ar57/wenyu/GeneRec/curvature_experiment/out/decoder/instruments_hgrec_v41/"
env["USE_POINC_INPUT_EMBED"] = "1"  # v41 创新开关 (Issue261): T5.shared → PoincareInputEmbedding (c=0.5)

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "codebook_diversity_loss_v325"  # v325 NOVEL: Codebook Diversity Loss (entropy maximization on soft assignment). R36v3.6 字面 PASS (Stage 1 端非曲率架构变更). v324 EMA R36p L1=66.4% FAIL 后, v325 直接对抗 codebook collapse: 算 softmax(-dist/τ) 算 soft assignment, 最大化 entropy → 鼓励 codebook 均匀使用. **论文支撑**: "Online Clustered Codebook" (ICML 2024) / BatchBalance / VQ-VAE 衍生. **R36n 灰色地带**: 不属 R36n 6 大方向 (a-f), 字面 PASS R36v3.6. 旧 v316_fixed baseline 备份在 /home/wlia0047/hj82_scratch2/wenyu/backup_curvature_v316_fixed/critical_artifacts/.

...
# v353 SWEEP: hardcoded module-level α for L0 geodesic midpoint commit
# α=1.0: pure input passthrough (no commit at all, midpoint = res)
MIDPOINT_ALPHA = 1.0
        ...
        for li, layer in enumerate(self.layers):
            ...
            if self.gate_M2_intrinsic:
                ...
                if self.use_geodesic_midpoint_commit and self.midpoint_layer_mask[li]:
                    ...
                    # v353 SWEEP: α parameterizes geodesic commitment depth

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v353_v348_alpha_1"  # ← v353 SWEEP (2026-09-03). 在 v348 (midpoint-only baseline, α=0.5) 基础上 sweep L0 geodesic midpoint α=1.0 (pure input passthrough, no commit).

...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "v228_direction_spread"  # ← v228 NOVEL: v227 hybrid manifold L0 卡在 ~50 codes (KMeans init direction cluster). v228 在 KMeans init 后给每个 codeword direction 加 random noise + 投到 anchor 球面. 打破 direction cluster, 解 L0 utility < 90%. R36n 合规: (e) 几何变换 (random rotation) + (c) manifold (球面投影). Stage 1 端纯几何变更. R36p v3.10 utility ≥ 90% 硬约束.

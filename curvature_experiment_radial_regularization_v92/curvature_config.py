...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "radial_regularization_v92"  # ← v92 Radial Regularization (R36 用户授权): 加 L_rad loss 把 codeword 从 ρ≈0.07-0.10 推到 [0.20, 0.70] 安全区间, 让 per-layer curvature 真正进入 hyperbolic 几何生效区. 不重设 ρ target=0.5 (太激进), 用区间约束避免 collapse. R36 + R36n 合规 (新增几何损失).

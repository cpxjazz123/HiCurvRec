...
# 默认 (sanity) wrapper: 最新架构 (per-layer curvature embed + conditioner heads), 指向 stage3 主脚本 (内联类定义, 逐字节一致)
DEFAULT_WRAPPER = "/fs04/ar57/wenyu/GeneRec/taskB/stage3/taskB_stage3.py"

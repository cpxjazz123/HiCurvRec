...
_t471_path = os.path.join(PROJECT, "taskB/stage3/taskB_stage3_mixed_curv_recontinue.py")
...
# Issue #13 Step P4-fix: 引入 long-run script 拿 autoregressive_predict + get_layer_ranges
...
CKPT_PATH = f"{PROJECT}/taskB/stage3/taskB_stage3_direction_b_train/adapter_200ep.pt"
DEVICE = "cuda"
D_MODEL = 128
MAX_LEN = 4
PAD_TOKEN = 0
...
def main():
    ...
    for run_id in [1, 2]:
        ...
        with torch.no_grad():
            for batch in test_loader:
                ...
                # Issue #13 Step P4-fix: 用 autoregressive_predict (layer-wise SID mask) 替换 parallel argmax
    ...
    # Save
    out_dir = "/home/wlia0047/ar57/wenyu/GeneRec/taskB/stage3/taskB_stage3_direction_b_train"

...
用法:
  python3 taskB/stage4/taskB_stage4_beam20_reeval.py \
      --device cuda:1 --n 1000 --tag issue29_diag \
      --ckpt "taskB/stage3/taskB_stage3_issue23_option_d.py@taskB/stage3/taskB_stage3_issue29_gate2_diag/best_adapter.pt"
"""
import argparse
...
DEFAULT_WRAPPER = "/fs04/ar57/wenyu/GeneRec/taskB/stage3/taskB_stage3_issue23_option_d.py"

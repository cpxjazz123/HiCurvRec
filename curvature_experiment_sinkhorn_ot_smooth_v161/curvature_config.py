...
# === 机制标识 (R52 + R53 联动) ===
MECHANISM_NAME = "sinkhorn_ot_smooth_v161"  # ← v161: v120 C-RVQ Mahalanobis + Sinkhorn-OT 均衡分配 (sk_eps=0.05, 10x 平滑 vs v159 0.005) + Poincaré 距离. R36n (c) manifold 几何 + (e) 几何变换 (Sinkhorn) + (f) 双曲度量. 温度微调期望突破 v159 regress -4.36%.

...
启动:
  CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node=4 --master_port=29500 \
      /home/wlia0047/ar57/wenyu/GeneRec/Euclidean_LearnableKappa/train_rqvae_instruments.py
...
=== 双曲机制 M3: LearnableKappa (本目录 Euclidean_LearnableKappa 唯一启用) ===
Poincare 距离 + learnable κ (sigmoid clamp 到 [1e-4, 10.0]); RQ-VAE 训练时优化曲率.
"""
import json
import os
import sys
